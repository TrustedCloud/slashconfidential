...
axiom _function_addr_high == 7340bv64;
...
mem := STORE_LE_64(mem, RSP, 7318bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1c96"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 7335bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1ca7"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_17,t1_11,t1_5,t2_12,t2_6,t_1;
