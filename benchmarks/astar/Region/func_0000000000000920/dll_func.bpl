...
axiom _function_addr_low == 2336bv64;
axiom _function_addr_high == 2367bv64;
...
mem := STORE_LE_64(mem, RSP, 2362bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x93a"} true;
call arbitrary_func();
