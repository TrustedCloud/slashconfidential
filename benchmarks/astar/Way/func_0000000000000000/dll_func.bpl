...
axiom _function_addr_high == 96bv64;
...
label_0xe:
t_1 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), 1bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), 1bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), 1bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), t_1)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_1, (LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))))), 1bv32)))));
...
label_0x19:
t_5 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), 1bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), 1bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), 1bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), t_5)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_5, (LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))))), 1bv32)))));
...
label_0x29:
RAX := (0bv32 ++ LOAD_LE_32(mem, PLUS_64(RAX, 20bv64)));

label_0x2c:
t_9 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), (RAX[32:0]));
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), (RAX[32:0])));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), (RAX[32:0]))), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))), t_9)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_9, (LOAD_LE_32(mem, PLUS_64(RSP, 16bv64))))), (RAX[32:0]))))));
...
label_0x3e:
t_13 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), (RAX[32:0]));
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), (RAX[32:0])));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), (RAX[32:0]))), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))), t_13)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_13, (LOAD_LE_32(mem, PLUS_64(RSP, 24bv64))))), (RAX[32:0]))))));
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_17,t_1,t_13,t_5,t_9;
