...
axiom _function_addr_high == 9767bv64;
...
label_0x25dd:
t_9 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 32bv64))), 256bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 32bv64))), 256bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 32bv64))), 256bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 32bv64))), t_9)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_9, (LOAD_LE_32(mem, PLUS_64(RSP, 32bv64))))), 256bv32)))));
...
label_0x25ec:
t_13 := TIMES_128(((ITE_128(bv2bool(RAX[64:63]) ,(1bv64 ++ RAX) ,(0bv64 ++ RAX)))), ((ITE_128(bv2bool(16bv64[64:63]) ,(1bv64 ++ 16bv64) ,(0bv64 ++ 16bv64)))));
RAX := t_13[64:0];
...
mem := STORE_LE_64(mem, RSP, 9733bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2605"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9748bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2614"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9762bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2622"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_21,t1_15,t2_16,t_1,t_13,t_5,t_9;
