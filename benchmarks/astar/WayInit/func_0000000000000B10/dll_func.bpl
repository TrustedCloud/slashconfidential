...
axiom _function_addr_low == 2832bv64;
axiom _function_addr_high == 3072bv64;
...
label_0xb33:
RAX := (0bv32 ++ OR_32((RAX[32:0]), (LOAD_LE_32(mem, PLUS_64(RSP, 40bv64)))));
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_3;
...
label_0xb5d:
origDEST_17 := RAX[32:0];
origCOUNT_18 := AND_32((RCX[32:0]), (MINUS_32(32bv32, 1bv32)));
RAX := (0bv32 ++ LSHIFT_32((RAX[32:0]), (AND_32((RCX[32:0]), (MINUS_32(32bv32, 1bv32))))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv32)), CF, RSHIFT_32(origDEST_17, (MINUS_32(32bv32, origCOUNT_18)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv32)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_18 == 1bv32)), XOR_1((RAX[32:0][32:31]), CF), unconstrained_5));
SF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv32)), SF, RAX[32:0][32:31]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv32)), ZF, bool2bv(0bv32 == (RAX[32:0])));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv32)), PF, NOT_1((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))))), 1bv32)), (XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv32)), AF, unconstrained_6);
...
label_0xb72:
t_25 := RAX[32:0][16:0];
RAX := (RAX[64:16]) ++ (MINUS_16((RAX[32:0][16:0]), 1bv16));
OF := AND_16((XOR_16(t_25, 1bv16)), (XOR_16(t_25, (RAX[32:0][16:0]))))[16:15];
AF := bool2bv(16bv16 == (AND_16(16bv16, (XOR_16((XOR_16((RAX[32:0][16:0]), t_25)), 1bv16)))));
...
label_0xb75:
mem := STORE_LE_16(mem, RSP, RAX[32:0][16:0]);
...
origCOUNT_30 := AND_32((RCX[32:0]), (MINUS_32(32bv32, 1bv32)));
RAX := (0bv32 ++ LSHIFT_32((RAX[32:0]), (AND_32((RCX[32:0]), (MINUS_32(32bv32, 1bv32))))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_30 == 0bv32)), CF, RSHIFT_32(origDEST_29, (MINUS_32(32bv32, origCOUNT_30)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_30 == 0bv32)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_30 == 1bv32)), XOR_1((RAX[32:0][32:31]), CF), unconstrained_8));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_30 == 0bv32)), AF, unconstrained_9);
...
label_0xb90:
origDEST_37 := RAX;
origCOUNT_38 := AND_64(1bv64, (MINUS_64(64bv64, 1bv64)));
RAX := LSHIFT_64(RAX, (AND_64(1bv64, (MINUS_64(64bv64, 1bv64)))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_38 == 0bv64)), CF, RSHIFT_64(origDEST_37, (MINUS_64(64bv64, origCOUNT_38)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_38 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_38 == 1bv64)), XOR_1((RAX[64:63]), CF), unconstrained_11));
...
label_0xbe3:
RCX := (0bv32 ++ (0bv16 ++ LOAD_LE_16(mem, RSP)));
...
t1_67 := RSP;
t2_68 := 24bv64;
RSP := PLUS_64(RSP, t2_68);
CF := bool2bv(LT_64(RSP, t1_67));
OF := AND_1((bool2bv((t1_67[64:63]) == (t2_68[64:63]))), (XOR_1((t1_67[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_67)), t2_68)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_18,origCOUNT_30,origCOUNT_38,origCOUNT_56,origCOUNT_6,origCOUNT_62,origDEST_17,origDEST_29,origDEST_37,origDEST_5,origDEST_55,origDEST_61,ra_73,t1_43,t1_67,t2_44,t2_68,t_1,t_13,t_25,t_51;
