...
axiom _function_addr_low == 18656bv64;
axiom _function_addr_high == 18730bv64;
...
label_0x4910:
R9 := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, PLUS_64(RDX, 24bv64))));
...
mem := STORE_LE_64(mem, RSP, 18725bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x4925"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_17,t1_11,t1_5,t2_12,t2_6,t_1;
