...
axiom _function_addr_low == 12288bv64;
axiom _function_addr_high == 12464bv64;
...
mem := STORE_LE_64(mem, RSP, 12330bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x302a"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 12356bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3044"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 12386bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3062"} true;
call arbitrary_func();
...
label_0x3071:
t_17 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 72bv64))), (RAX[32:0]));
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 72bv64))), (RAX[32:0])));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 72bv64))), (RAX[32:0]))), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 72bv64))), t_17)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_17, (LOAD_LE_32(mem, PLUS_64(RSP, 72bv64))))), (RAX[32:0]))))));
...
label_0x307b:
t_21 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))), (RAX[32:0]));
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))), (RAX[32:0])));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))), (RAX[32:0]))), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))), t_21)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_21, (LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))))), (RAX[32:0]))))));
...
label_0x308d:
R9 := (0bv32 ++ LOAD_LE_32(mem, PLUS_64(RSP, 88bv64)));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 12453bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x30a5"} true;
call arbitrary_func();

label_0x30a5:
t1_25 := RSP;
t2_26 := 56bv64;
RSP := PLUS_64(RSP, t2_26);
CF := bool2bv(LT_64(RSP, t1_25));
OF := AND_1((bool2bv((t1_25[64:63]) == (t2_26[64:63]))), (XOR_1((t1_25[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_25)), t2_26)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_31,t1_25,t2_26,t_1,t_13,t_17,t_21,t_5,t_9;
