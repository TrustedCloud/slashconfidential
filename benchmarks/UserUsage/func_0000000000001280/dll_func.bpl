...
axiom _function_addr_low == 4736bv64;
axiom _function_addr_high == 4783bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4769bv64);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RBX,RCX,RDI,RDX,RSP,SF,ZF,mem,ra_17,t1_11,t2_12,t_1,t_3,t_7;
