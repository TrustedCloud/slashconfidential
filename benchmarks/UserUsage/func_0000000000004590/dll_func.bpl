...
axiom _function_addr_low == 17808bv64;
axiom _function_addr_high == 18015bv64;
...
label_0x4596:
RAX := (0bv32 ++ LOAD_LE_32(mem, PLUS_64((PLUS_64(7092bv64, 17820bv64)), 0bv64)));
...
label_0x45a7:
RAX := PLUS_64((PLUS_64(7082bv64, 17838bv64)), 0bv64)[64:0];

label_0x45ae:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7071bv64, 17845bv64)), 4bv64), 3bv64);

label_0x45b9:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7128bv64, 17856bv64)), 0bv64), RAX);

label_0x45c0:
RAX := LOAD_LE_64(mem, PLUS_64(RSP, 80bv64));

label_0x45c5:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7132bv64, 17868bv64)), 0bv64), RAX);

label_0x45cc:
RAX := (0bv32 ++ 1bv32);

label_0x45d1:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7048bv64, 17880bv64)), 0bv64), R9);

label_0x45d8:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7049bv64, 17887bv64)), 0bv64), RDX);

label_0x45df:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7062bv64, 17894bv64)), 4bv64), 0bv64);

label_0x45ea:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7111bv64, 17905bv64)), 0bv64), R8);

label_0x45f1:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7096bv64, 17912bv64)), 0bv64), RDX);

label_0x45f8:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(7073bv64, 17919bv64)), 0bv64), R9);

label_0x45ff:
t_11 := RAX[32:0];
RAX := (0bv32 ++ LOAD_LE_32(mem, PLUS_64((PLUS_64(6987bv64, 17925bv64)), 0bv64)));
mem := STORE_LE_32(mem, PLUS_64((PLUS_64(6987bv64, 17925bv64)), 0bv64), t_11);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 17934bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x4720"} true;
call arbitrary_func();

label_0x460e:
t_17 := MINUS_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(6963bv64, 17940bv64)), 1bv64))), 0bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(6963bv64, 17940bv64)), 1bv64))), 0bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(6963bv64, 17940bv64)), 1bv64))), 0bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(6963bv64, 17940bv64)), 1bv64))), t_17)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_17, (LOAD_LE_32(mem, PLUS_64((PLUS_64(6963bv64, 17940bv64)), 1bv64))))), 0bv32)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 17951bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x4680"} true;
call arbitrary_func();

label_0x461f:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(7018bv64, 17958bv64)), 0bv64));
...
target_25 := RAX;
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 17974bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "target_25"} true;
call arbitrary_func();

label_0x4636:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(6987bv64, 17981bv64)), 0bv64));
...
target_31 := RAX;
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 17988bv64);
...
label_0x4654:
assert {:SlashVerifyCommandType "remotejmp"} {:SlashVerifyJmpTarget "0x4580"} true;
return;
