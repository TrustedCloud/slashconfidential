...
axiom _function_addr_low == 11360bv64;
axiom _function_addr_high == 11519bv64;
...
label_0x2c98:
RCX := PLUS_64((PLUS_64(1793bv64, 11423bv64)), 0bv64)[64:0];

label_0x2c9f:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 11428bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2a70"} true;
call arbitrary_func();
...
label_0x2cbf:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(13530bv64, 11462bv64)), 0bv64));
