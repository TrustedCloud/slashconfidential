...
axiom _function_addr_low == 4880bv64;
axiom _function_addr_high == 4972bv64;
...
label_0x132e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(20075bv64, 4917bv64)), 0bv64));
...
label_0x134e:
RAX := PLUS_64((PLUS_64(15931bv64, 4949bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4963bv64);
