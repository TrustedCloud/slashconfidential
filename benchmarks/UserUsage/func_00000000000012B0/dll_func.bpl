...
axiom _function_addr_low == 4784bv64;
axiom _function_addr_high == 4876bv64;
...
label_0x12ce:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(20171bv64, 4821bv64)), 0bv64));
...
R8 := RSHIFT_64(R8, (AND_64(9bv64, (MINUS_64(64bv64, 1bv64)))));
...
label_0x12dc:
RDX := LOAD_LE_64(mem, PLUS_64(RAX, (LSHIFT_64(R8, 3bv64))));
...
label_0x12ee:
RAX := PLUS_64((PLUS_64(15939bv64, 4853bv64)), 0bv64)[64:0];

label_0x12f5:
mem := STORE_LE_64(mem, RCX, RAX);

label_0x12f8:
t_23 := AND_8((R9[32:0][8:0]), 1bv8);
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_11;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4867bv64);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RBX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origDEST_11,origDEST_17,ra_33,t1_27,t2_28,t_1,t_23,t_3;
