...
axiom _function_addr_high == 6956bv64;
...
mem := STORE_LE_64(mem, RSP, 6862bv64);
...
label_0x1aef:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(18090bv64, 6902bv64)), 0bv64));
...
label_0x1b0d:
RAX := PLUS_64((PLUS_64(14076bv64, 6932bv64)), 0bv64)[64:0];

label_0x1b14:
mem := STORE_LE_32(mem, PLUS_64(R8, 8bv64), 10bv32);
