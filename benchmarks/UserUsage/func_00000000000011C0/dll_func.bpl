...
axiom _function_addr_high == 4721bv64;
...
label_0x11df:
RDI := LOAD_LE_64(mem, PLUS_64((PLUS_64(20410bv64, 4582bv64)), 0bv64));
...
label_0x11fc:
RAX := PLUS_64((PLUS_64(16413bv64, 4611bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4635bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4643bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4657bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2420"} true;
call arbitrary_func();
...
label_0x125c:
RAX := PLUS_64((PLUS_64(16165bv64, 4707bv64)), 0bv64)[64:0];
