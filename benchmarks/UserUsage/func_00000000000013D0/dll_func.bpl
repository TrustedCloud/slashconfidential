...
axiom _function_addr_low == 5072bv64;
axiom _function_addr_high == 5164bv64;
...
label_0x13ee:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(19883bv64, 5109bv64)), 0bv64));
...
label_0x140e:
RAX := PLUS_64((PLUS_64(15731bv64, 5141bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5155bv64);
