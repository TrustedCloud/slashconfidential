...
axiom _function_addr_low == 4416bv64;
axiom _function_addr_high == 4543bv64;
...
label_0x1140:
RAX := PLUS_64((PLUS_64(16513bv64, 4423bv64)), 0bv64)[64:0];
...
label_0x1160:
R8 := LOAD_LE_64(mem, PLUS_64((PLUS_64(20537bv64, 4455bv64)), 0bv64));
...
label_0x118f:
mem := STORE_LE_64(mem, PLUS_64(RDX, 8bv64), R9);
...
label_0x11ba:
mem := STORE_LE_64(mem, PLUS_64(RDX, 16bv64), R9);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origCOUNT_28,origCOUNT_34,origDEST_11,origDEST_17,origDEST_27,origDEST_33,ra_39,t1_5,t2_6;
