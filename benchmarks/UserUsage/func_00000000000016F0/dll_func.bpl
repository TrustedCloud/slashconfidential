...
axiom _function_addr_low == 5872bv64;
axiom _function_addr_high == 6013bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5898bv64);
...
label_0x1716:
mem := STORE_LE_64(mem, PLUS_64(RSP, 48bv64), RBX);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5926bv64);
...
target_15 := RBX;
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5936bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "target_15"} true;
call arbitrary_func();
...
label_0x174d:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(19020bv64, 5972bv64)), 0bv64));

label_0x1754:
RCX := PLUS_64(RDI, 16bv64)[64:0];
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_22 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_22 == 1bv64)), origDEST_21[64:63], unconstrained_4));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_22 == 0bv64)), AF, unconstrained_5);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_28 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_28 == 1bv64)), origDEST_27[64:63], unconstrained_6));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_28 == 0bv64)), AF, unconstrained_7);
...
label_0x176f:
mem := STORE_LE_64(mem, PLUS_64(RDI, 16bv64), 0bv64);

label_0x1777:
t1_33 := RSP;
t2_34 := 32bv64;
RSP := PLUS_64(RSP, t2_34);
CF := bool2bv(LT_64(RSP, t1_33));
OF := AND_1((bool2bv((t1_33[64:63]) == (t2_34[64:63]))), (XOR_1((t1_33[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_33)), t2_34)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RBX,RCX,RDI,RDX,RSI,RSP,SF,ZF,mem,origCOUNT_22,origCOUNT_28,origDEST_21,origDEST_27,ra_39,t1_33,t2_34,t_1,t_11,t_3,t_7,target_15;
