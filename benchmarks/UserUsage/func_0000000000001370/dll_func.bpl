...
axiom _function_addr_low == 4976bv64;
axiom _function_addr_high == 5068bv64;
...
label_0x138e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(19979bv64, 5013bv64)), 0bv64));
...
label_0x13ae:
RAX := PLUS_64((PLUS_64(15947bv64, 5045bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5059bv64);
