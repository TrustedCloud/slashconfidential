...
axiom _function_addr_low == 8720bv64;
axiom _function_addr_high == 8828bv64;
...
label_0x2230:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(16233bv64, 8759bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8809bv64);
