...
axiom _function_addr_low == 6640bv64;
axiom _function_addr_high == 6790bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 6671bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 6693bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1090"} true;
call arbitrary_func();
...
label_0x1a39:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(18272bv64, 6720bv64)), 0bv64));
...
label_0x1a59:
RAX := PLUS_64((PLUS_64(14080bv64, 6752bv64)), 0bv64)[64:0];
