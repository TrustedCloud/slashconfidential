...
axiom _function_addr_low == 18208bv64;
axiom _function_addr_high == 18363bv64;
...
label_0x472f:
RSI := PLUS_64((PLUS_64(2490bv64, 18230bv64)), 0bv64)[64:0];

label_0x4736:
RDI := RCX;

label_0x4739:
RAX := PLUS_64((PLUS_64(2464bv64, 18240bv64)), 0bv64)[64:0];
...
label_0x4746:
RBX := PLUS_64((PLUS_64(2467bv64, 18253bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 18275bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x4450"} true;
call arbitrary_func();
...
label_0x476c:
RSI := PLUS_64((PLUS_64(2405bv64, 18291bv64)), 0bv64)[64:0];

label_0x4773:
RAX := PLUS_64((PLUS_64(2350bv64, 18298bv64)), 0bv64)[64:0];
...
label_0x4780:
RBX := PLUS_64((PLUS_64(2345bv64, 18311bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 18338bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x4450"} true;
call arbitrary_func();
