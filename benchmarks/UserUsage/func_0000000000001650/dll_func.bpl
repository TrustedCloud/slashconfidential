...
axiom _function_addr_low == 5712bv64;
axiom _function_addr_high == 5833bv64;
...
label_0x1666:
R8 := LOAD_LE_64(mem, PLUS_64((PLUS_64(19251bv64, 5741bv64)), 0bv64));
...
label_0x16c4:
assert {:SlashVerifyCommandType "remotejmp"} {:SlashVerifyJmpTarget "0x1d00"} true;
return;
