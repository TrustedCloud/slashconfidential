...
axiom _function_addr_low == 11536bv64;
axiom _function_addr_high == 11667bv64;
...
label_0x2d23:
RBX := LOAD_LE_64(mem, PLUS_64((PLUS_64(13430bv64, 11562bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 11616bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2c60"} true;
call arbitrary_func();
