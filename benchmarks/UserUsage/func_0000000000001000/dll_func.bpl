...
axiom _function_addr_high == 4233bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4110bv64);
...
label_0x1020:
RDX := LOAD_LE_64(mem, PLUS_64((PLUS_64(20857bv64, 4135bv64)), 0bv64));
...
label_0x1040:
RAX := PLUS_64((PLUS_64(16857bv64, 4167bv64)), 0bv64)[64:0];
...
t1_39 := RSP;
t2_40 := 32bv64;
RSP := PLUS_64(RSP, t2_40);
CF := bool2bv(LT_64(RSP, t1_39));
OF := AND_1((bool2bv((t1_39[64:63]) == (t2_40[64:63]))), (XOR_1((t1_39[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_39)), t2_40)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RBX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origCOUNT_28,origCOUNT_34,origDEST_11,origDEST_17,origDEST_27,origDEST_33,ra_45,t1_39,t2_40,t_1,t_3;
