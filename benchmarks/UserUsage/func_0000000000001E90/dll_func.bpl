...
axiom _function_addr_low == 7824bv64;
axiom _function_addr_high == 8071bv64;
...
label_0x1e96:
t_7 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RCX, 8bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RCX, 8bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RCX, 8bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RCX, 8bv64))), t_7)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_7, (LOAD_LE_64(mem, PLUS_64(RCX, 8bv64))))), 0bv64)))));
...
label_0x1ec1:
RSI := LOAD_LE_64(mem, PLUS_64((PLUS_64(17112bv64, 7880bv64)), 0bv64));
...
label_0x1ee8:
mem := STORE_LE_64(mem, PLUS_64(RBX, 8bv64), 0bv64);

label_0x1ef0:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 7925bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 7946bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1000"} true;
call arbitrary_func();
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_42 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_42 == 1bv64)), origDEST_41[64:63], unconstrained_14));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_42 == 0bv64)), AF, unconstrained_15);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_48 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_48 == 1bv64)), origDEST_47[64:63], unconstrained_16));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_48 == 0bv64)), AF, unconstrained_17);
...
label_0x1f37:
RAX := PLUS_64((PLUS_64(13050bv64, 7998bv64)), 0bv64)[64:0];
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_58 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_58 == 1bv64)), origDEST_57[64:63], unconstrained_25));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_58 == 0bv64)), AF, unconstrained_26);
...
label_0x1f68:
RSI := LOAD_LE_64(mem, PLUS_64(RSP, 48bv64));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_64 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_64 == 1bv64)), origDEST_63[64:63], unconstrained_27));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_64 == 0bv64)), AF, unconstrained_28);
...
label_0x1f78:
mem := STORE_LE_64(mem, PLUS_64(RBX, 16bv64), RDI);

label_0x1f7c:
RDI := LOAD_LE_64(mem, PLUS_64(RSP, 56bv64));
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RBX,RCX,RDI,RDX,RSI,RSP,SF,ZF,mem,origCOUNT_22,origCOUNT_28,origCOUNT_42,origCOUNT_48,origCOUNT_58,origCOUNT_64,origDEST_21,origDEST_27,origDEST_41,origDEST_47,origDEST_57,origDEST_63,ra_75,t1_15,t1_69,t2_16,t2_70,t_1,t_3,t_33,t_7;
