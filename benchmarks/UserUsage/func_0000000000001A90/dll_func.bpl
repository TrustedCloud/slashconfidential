...
axiom _function_addr_low == 6800bv64;
axiom _function_addr_high == 6836bv64;
...
mem := STORE_LE_64(mem, RSP, 6814bv64);
...
label_0x1aaa:
assert {:SlashVerifyCommandType "remotejmp"} {:SlashVerifyJmpTarget "0x1140"} true;
return;
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_21,t1_15,t1_9,t2_10,t2_16,t_1,t_5;
