...
axiom _function_addr_low == 9808bv64;
axiom _function_addr_high == 10077bv64;
...
label_0x2679:
RBX := LOAD_LE_64(mem, PLUS_64((PLUS_64(15136bv64, 9856bv64)), 0bv64));
...
label_0x2696:
RAX := PLUS_64((PLUS_64(10987bv64, 9885bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9966bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10040bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10053bv64);
