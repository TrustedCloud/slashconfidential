...
axiom _function_addr_high == 4230bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4211bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4223bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x10c0"} true;
call arbitrary_func();
