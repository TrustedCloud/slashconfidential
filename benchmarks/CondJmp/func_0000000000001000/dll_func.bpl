...
axiom _function_addr_high == 4149bv64;
...
t1_5 := RCX[32:0];
t2_6 := RAX[32:0];
RCX := (0bv32 ++ PLUS_32((RCX[32:0]), t2_6));
CF := bool2bv(LT_32((RCX[32:0]), t1_5));
OF := AND_1((bool2bv((t1_5[32:31]) == (t2_6[32:31]))), (XOR_1((t1_5[32:31]), (RCX[32:0][32:31]))));
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32((RCX[32:0]), t1_5)), t2_6)))));
...
origCOUNT_12 := AND_32(2bv32, (MINUS_32(32bv32, 1bv32)));
RAX := (0bv32 ++ LSHIFT_32((RAX[32:0]), (AND_32(2bv32, (MINUS_32(32bv32, 1bv32))))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv32)), CF, RSHIFT_32(origDEST_11, (MINUS_32(32bv32, origCOUNT_12)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv32)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_12 == 1bv32)), XOR_1((RAX[32:0][32:31]), CF), unconstrained_1));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv32)), AF, unconstrained_2);

label_0x101b:
mem := STORE_LE_32(mem, RSP, RAX[32:0]);

label_0x101e:
t_17 := MINUS_32((LOAD_LE_32(mem, RSP)), 5bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, RSP)), 5bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, RSP)), 5bv32)), (XOR_32((LOAD_LE_32(mem, RSP)), t_17)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_17, (LOAD_LE_32(mem, RSP)))), 5bv32)))));
...
t1_21 := RSP;
t2_22 := 24bv64;
RSP := PLUS_64(RSP, t2_22);
CF := bool2bv(LT_64(RSP, t1_21));
OF := AND_1((bool2bv((t1_21[64:63]) == (t2_22[64:63]))), (XOR_1((t1_21[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_21)), t2_22)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origDEST_11,ra_27,t1_21,t1_5,t2_22,t2_6,t_1,t_17;
