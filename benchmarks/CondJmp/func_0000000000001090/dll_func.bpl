...
axiom _function_addr_high == 4275bv64;
...
label_0x10a2:
RCX := PLUS_64((PLUS_64(4294967295bv32 ++ 4294963031bv32, 4265bv64)), 0bv64)[64:0];

label_0x10a9:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4270bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x10d0"} true;
call arbitrary_func();
