...
axiom _function_addr_low == 7952bv64;
axiom _function_addr_high == 8078bv64;
...
mem := STORE_LE_64(mem, RSP, 7999bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1ea0"} true;
call arbitrary_func();
...
label_0x1f5f:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(4314bv64, 8038bv64)), 0bv64));
