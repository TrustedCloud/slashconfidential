...
axiom _function_addr_low == 10800bv64;
axiom _function_addr_high == 10925bv64;
...
label_0x2a39:
RAX := PLUS_64((PLUS_64(1552bv64, 10816bv64)), 0bv64)[64:0];

label_0x2a40:
RCX := PLUS_64((PLUS_64(1537bv64, 10823bv64)), 0bv64)[64:0];
...
label_0x2a4d:
RAX := PLUS_64((PLUS_64(1524bv64, 10836bv64)), 0bv64)[64:0];
...
label_0x2a6d:
RAX := PLUS_64((PLUS_64(1500bv64, 10868bv64)), 0bv64)[64:0];
...
mem := STORE_LE_64(mem, RSP, 10918bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1620"} true;
call arbitrary_func();
