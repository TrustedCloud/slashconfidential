...
axiom _function_addr_low == 7088bv64;
axiom _function_addr_high == 7157bv64;
...
mem := STORE_LE_64(mem, RSP, 7112bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x22b0"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 7143bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2030"} true;
call arbitrary_func();
