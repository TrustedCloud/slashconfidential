...
axiom _function_addr_low == 5904bv64;
axiom _function_addr_high == 5962bv64;
...
mem := STORE_LE_64(mem, RSP, 5933bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1450"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5957bv64);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RCX,RDX,RSP,SF,ZF,mem,ra_11,t1_5,t2_6,t_1;
