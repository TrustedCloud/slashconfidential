...
axiom _function_addr_high == 4782bv64;
...
label_0x1289:
RCX := PLUS_64((PLUS_64(11640bv64, 4752bv64)), 0bv64)[64:0];

label_0x1290:
t_5 := RAX[32:0];
RAX := (0bv32 ++ LOAD_LE_32(mem, RCX));
mem := STORE_LE_32(mem, RCX, t_5);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_17,t1_11,t2_12,t_1,t_5,t_7;
