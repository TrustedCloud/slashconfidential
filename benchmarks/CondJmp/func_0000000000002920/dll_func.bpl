...
axiom _function_addr_low == 10528bv64;
axiom _function_addr_high == 10653bv64;
...
label_0x2929:
RAX := PLUS_64((PLUS_64(1856bv64, 10544bv64)), 0bv64)[64:0];

label_0x2930:
RCX := PLUS_64((PLUS_64(1833bv64, 10551bv64)), 0bv64)[64:0];
...
label_0x293d:
RAX := PLUS_64((PLUS_64(1820bv64, 10564bv64)), 0bv64)[64:0];
...
label_0x295d:
RAX := PLUS_64((PLUS_64(1804bv64, 10596bv64)), 0bv64)[64:0];
...
label_0x2970:
t_25 := MINUS_64((LOAD_LE_64(mem, RAX)), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, RAX)), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, RAX)), 0bv64)), (XOR_64((LOAD_LE_64(mem, RAX)), t_25)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_25, (LOAD_LE_64(mem, RAX)))), 0bv64)))));
...
mem := STORE_LE_64(mem, RSP, 10636bv64);
...
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2a30"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_35,t1_15,t1_29,t1_9,t2_10,t2_16,t2_30,t_1,t_21,t_25,t_5;
