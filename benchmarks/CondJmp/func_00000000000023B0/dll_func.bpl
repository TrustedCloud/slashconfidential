...
axiom _function_addr_low == 9136bv64;
axiom _function_addr_high == 9198bv64;
...
mem := STORE_LE_64(mem, RSP, 9145bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x25d0"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9193bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1660"} true;
call arbitrary_func();
