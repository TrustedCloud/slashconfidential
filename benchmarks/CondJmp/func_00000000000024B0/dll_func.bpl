...
axiom _function_addr_low == 9392bv64;
axiom _function_addr_high == 9416bv64;
...
mem := STORE_LE_64(mem, RSP, 9411bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1c00"} true;
call arbitrary_func();
