...
axiom _function_addr_high == 4466bv64;
...
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1180"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4442bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4447bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x10a0"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4459bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x11b0"} true;
call arbitrary_func();
