...
axiom _function_addr_low == 8480bv64;
axiom _function_addr_high == 8542bv64;
...
mem := STORE_LE_64(mem, RSP, 8489bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2340"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8537bv64);
