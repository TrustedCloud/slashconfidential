...
axiom _function_addr_low == 10480bv64;
axiom _function_addr_high == 10761bv64;
...
label_0x296a:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(1743bv64, 10609bv64)), 0bv64));
...
label_0x2978:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(1721bv64, 10623bv64)), 0bv64));

label_0x297f:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(1722bv64, 10630bv64)), 0bv64));
...
label_0x2993:
t_39 := MINUS_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(5798bv64, 10649bv64)), 1bv64))), 0bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(5798bv64, 10649bv64)), 1bv64))), 0bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(5798bv64, 10649bv64)), 1bv64))), 0bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64((PLUS_64(5798bv64, 10649bv64)), 1bv64))), t_39)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_39, (LOAD_LE_32(mem, PLUS_64((PLUS_64(5798bv64, 10649bv64)), 1bv64))))), 0bv32)))));
...
label_0x299c:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(1677bv64, 10659bv64)), 0bv64));
...
label_0x29aa:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(1655bv64, 10673bv64)), 0bv64));

label_0x29b1:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(1656bv64, 10680bv64)), 0bv64));
...
label_0x29cb:
R8 := (0bv32 ++ LOAD_LE_32(mem, PLUS_64((PLUS_64(5678bv64, 10706bv64)), 0bv64)));
...
target_57 := LOAD_LE_64(mem, PLUS_64((PLUS_64(1582bv64, 10722bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10722bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10747bv64);
