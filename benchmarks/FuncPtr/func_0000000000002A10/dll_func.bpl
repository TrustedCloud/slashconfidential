...
axiom _function_addr_low == 10768bv64;
axiom _function_addr_high == 10893bv64;
...
label_0x2a19:
RAX := PLUS_64((PLUS_64(1616bv64, 10784bv64)), 0bv64)[64:0];

label_0x2a20:
RCX := PLUS_64((PLUS_64(1593bv64, 10791bv64)), 0bv64)[64:0];
...
label_0x2a2d:
RAX := PLUS_64((PLUS_64(1580bv64, 10804bv64)), 0bv64)[64:0];
...
label_0x2a4d:
RAX := PLUS_64((PLUS_64(1564bv64, 10836bv64)), 0bv64)[64:0];
...
mem := STORE_LE_64(mem, RSP, 10876bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10888bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2b20"} true;
call arbitrary_func();
