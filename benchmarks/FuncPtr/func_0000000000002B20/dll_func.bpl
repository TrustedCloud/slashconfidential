...
axiom _function_addr_low == 11040bv64;
axiom _function_addr_high == 11165bv64;
...
label_0x2b29:
RAX := PLUS_64((PLUS_64(1312bv64, 11056bv64)), 0bv64)[64:0];

label_0x2b30:
RCX := PLUS_64((PLUS_64(1297bv64, 11063bv64)), 0bv64)[64:0];
...
label_0x2b3d:
RAX := PLUS_64((PLUS_64(1284bv64, 11076bv64)), 0bv64)[64:0];
...
label_0x2b5d:
RAX := PLUS_64((PLUS_64(1260bv64, 11108bv64)), 0bv64)[64:0];
...
mem := STORE_LE_64(mem, RSP, 11158bv64);
