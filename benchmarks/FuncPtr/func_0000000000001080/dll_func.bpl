...
axiom _function_addr_high == 4245bv64;
...
t1_1 := RCX[32:0];
t2_2 := RAX[32:0];
RCX := (0bv32 ++ PLUS_32((RCX[32:0]), t2_2));
CF := bool2bv(LT_32((RCX[32:0]), t1_1));
OF := AND_1((bool2bv((t1_1[32:31]) == (t2_2[32:31]))), (XOR_1((t1_1[32:31]), (RCX[32:0][32:31]))));
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32((RCX[32:0]), t1_1)), t2_2)))));
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_7,t1_1,t2_2;
