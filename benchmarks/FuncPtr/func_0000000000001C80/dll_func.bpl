...
axiom _function_addr_low == 7296bv64;
axiom _function_addr_high == 7422bv64;
...
mem := STORE_LE_64(mem, RSP, 7343bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1c10"} true;
call arbitrary_func();
...
label_0x1ccf:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(4970bv64, 7382bv64)), 0bv64));
