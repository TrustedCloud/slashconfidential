...
axiom _function_addr_low == 5248bv64;
axiom _function_addr_high == 5306bv64;
...
mem := STORE_LE_64(mem, RSP, 5277bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x11c0"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5301bv64);
