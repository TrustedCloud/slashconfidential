...
axiom _function_addr_low == 4480bv64;
axiom _function_addr_high == 4515bv64;
...
label_0x1192:
RCX := PLUS_64((PLUS_64(4294967295bv32 ++ 4294962791bv32, 4505bv64)), 0bv64)[64:0];

label_0x1199:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4510bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2350"} true;
call arbitrary_func();
