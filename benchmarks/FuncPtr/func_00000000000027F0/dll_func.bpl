...
axiom _function_addr_low == 10224bv64;
axiom _function_addr_high == 10462bv64;
...
mem := STORE_LE_64(mem, RSP, 10271bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x26d0"} true;
call arbitrary_func();
...
target_5 := LOAD_LE_64(mem, PLUS_64((PLUS_64(2006bv64, 10298bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10298bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10340bv64);
...
target_11 := LOAD_LE_64(mem, PLUS_64((PLUS_64(1933bv64, 10371bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10371bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10413bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x24e0"} true;
call arbitrary_func();
...
label_0x28b1:
RDX := PLUS_64((PLUS_64(56bv64, 10424bv64)), 0bv64)[64:0];
...
target_17 := LOAD_LE_64(mem, PLUS_64((PLUS_64(1853bv64, 10435bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10435bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10452bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x24e0"} true;
call arbitrary_func();
