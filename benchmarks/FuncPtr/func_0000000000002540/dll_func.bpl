...
axiom _function_addr_low == 9536bv64;
axiom _function_addr_high == 9934bv64;
...
label_0x2560:
RAX := PLUS_64((PLUS_64(2753bv64, 9575bv64)), 0bv64)[64:0];

label_0x2567:
mem := STORE_LE_64(mem, PLUS_64(RSP, 40bv64), RAX);

label_0x256c:
RAX := PLUS_64((PLUS_64(2741bv64, 9587bv64)), 0bv64)[64:0];
...
label_0x257c:
RAX := PLUS_64((PLUS_64(2733bv64, 9603bv64)), 0bv64)[64:0];
...
label_0x258a:
RAX := PLUS_64((PLUS_64(2719bv64, 9617bv64)), 0bv64)[64:0];

label_0x2591:
mem := STORE_LE_64(mem, PLUS_64(RSP, 40bv64), RAX);

label_0x2596:
RAX := PLUS_64((PLUS_64(2707bv64, 9629bv64)), 0bv64)[64:0];
...
label_0x25a8:
RAX := PLUS_64((PLUS_64(2689bv64, 9647bv64)), 0bv64)[64:0];
...
label_0x25b8:
RAX := PLUS_64((PLUS_64(2689bv64, 9663bv64)), 0bv64)[64:0];
...
label_0x25c6:
RAX := PLUS_64((PLUS_64(2675bv64, 9677bv64)), 0bv64)[64:0];

label_0x25cd:
mem := STORE_LE_64(mem, PLUS_64(RSP, 40bv64), RAX);

label_0x25d2:
RAX := PLUS_64((PLUS_64(2663bv64, 9689bv64)), 0bv64)[64:0];
...
label_0x25e4:
RAX := PLUS_64((PLUS_64(2645bv64, 9707bv64)), 0bv64)[64:0];
...
label_0x25f4:
RAX := PLUS_64((PLUS_64(2621bv64, 9723bv64)), 0bv64)[64:0];
...
label_0x2602:
RAX := PLUS_64((PLUS_64(2607bv64, 9737bv64)), 0bv64)[64:0];

label_0x2609:
mem := STORE_LE_64(mem, PLUS_64(RSP, 40bv64), RAX);

label_0x260e:
RAX := PLUS_64((PLUS_64(2595bv64, 9749bv64)), 0bv64)[64:0];
...
label_0x2620:
RAX := PLUS_64((PLUS_64(2577bv64, 9767bv64)), 0bv64)[64:0];
...
target_75 := LOAD_LE_64(mem, PLUS_64((PLUS_64(2495bv64, 9817bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9817bv64);
...
label_0x2669:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(2488bv64, 9840bv64)), 0bv64), RAX);

label_0x2670:
RAX := LOAD_LE_64(mem, PLUS_64(RSP, 80bv64));

label_0x2675:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(2484bv64, 9852bv64)), 0bv64), RAX);

label_0x267c:
RAX := LOAD_LE_64(mem, PLUS_64(RSP, 104bv64));

label_0x2681:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(2480bv64, 9864bv64)), 0bv64), RAX);

label_0x2688:
RAX := LOAD_LE_64(mem, PLUS_64(RSP, 96bv64));

label_0x268d:
mem := STORE_LE_64(mem, PLUS_64((PLUS_64(2476bv64, 9876bv64)), 0bv64), RAX);
...
target_85 := LOAD_LE_64(mem, PLUS_64((PLUS_64(2396bv64, 9916bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9916bv64);
