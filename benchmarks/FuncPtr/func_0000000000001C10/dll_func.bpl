...
axiom _function_addr_low == 7184bv64;
axiom _function_addr_high == 7288bv64;
...
label_0x1c31:
origDEST_7 := RAX;
origCOUNT_8 := AND_64(3bv64, (MINUS_64(64bv64, 1bv64)));
...
label_0x1c39:
t_13 := MINUS_64((LOAD_LE_64(mem, RSP)), 64bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, RSP)), 64bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, RSP)), 64bv64)), (XOR_64((LOAD_LE_64(mem, RSP)), t_13)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_13, (LOAD_LE_64(mem, RSP)))), 64bv64)))));
...
label_0x1c40:
mem := STORE_LE_64(mem, PLUS_64(RSP, 8bv64), 4294967295bv32 ++ 4294967295bv32);
...
label_0x1c63:
origDEST_17 := RAX;
origCOUNT_18 := AND_64(RCX, (MINUS_64(64bv64, 1bv64)));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_18 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_18 == 1bv64)), XOR_1((RAX[64:63]), CF), unconstrained_4));
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_18,origCOUNT_8,origDEST_17,origDEST_7,ra_29,t1_23,t2_24,t_1,t_13;
