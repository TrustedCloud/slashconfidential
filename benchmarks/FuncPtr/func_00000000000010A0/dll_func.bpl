...
axiom _function_addr_low == 4256bv64;
axiom _function_addr_high == 4401bv64;
...
label_0x10a4:
RAX := PLUS_64((PLUS_64(4294967295bv32 ++ 4294967253bv32, 4267bv64)), 0bv64)[64:0];
...
mem := STORE_LE_64(mem, RSP, 4292bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2220"} true;
call arbitrary_func();
...
target_5 := LOAD_LE_64(mem, PLUS_64(RSP, 40bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4306bv64);
...
label_0x10de:
t_7 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), 1bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), 1bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), 1bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), t_7)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_7, (LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))))), 1bv32)))));
...
label_0x10e5:
t_11 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), 2bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), 2bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), 2bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))), t_11)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_11, (LOAD_LE_32(mem, PLUS_64(RSP, 36bv64))))), 2bv32)))));
PF := NOT_1((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32(t_11, 4bv32)), t_11)), 2bv32)), (XOR_32((RSHIFT_32(t_11, 4bv32)), t_11)))), 1bv32)), (XOR_32((RSHIFT_32((XOR_32((RSHIFT_32(t_11, 4bv32)), t_11)), 2bv32)), (XOR_32((RSHIFT_32(t_11, 4bv32)), t_11)))))[1:0]));
SF := t_11[32:31];
ZF := bool2bv(0bv32 == t_11);
...
OF := AND_1((bool2bv((t_15[32:31]) == (1bv32[32:31]))), (XOR_1((t_15[32:31]), (RAX[32:0][32:31]))));
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32((RAX[32:0]), t_15)), 1bv32)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4366bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2220"} true;
call arbitrary_func();
...
target_19 := LOAD_LE_64(mem, PLUS_64(RSP, 56bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4379bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "target_19"} true;
call arbitrary_func();
...
t1_21 := RAX[32:0];
t2_22 := 3bv32;
RAX := (0bv32 ++ PLUS_32((RAX[32:0]), t2_22));
CF := bool2bv(LT_32((RAX[32:0]), t1_21));
OF := AND_1((bool2bv((t1_21[32:31]) == (t2_22[32:31]))), (XOR_1((t1_21[32:31]), (RAX[32:0][32:31]))));
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32((RAX[32:0]), t1_21)), t2_22)))));
PF := NOT_1((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))))), 1bv32)), (XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))))))[1:0]));
SF := RAX[32:0][32:31];
ZF := bool2bv(0bv32 == (RAX[32:0]));
...
t1_27 := RSP;
t2_28 := 72bv64;
RSP := PLUS_64(RSP, t2_28);
CF := bool2bv(LT_64(RSP, t1_27));
OF := AND_1((bool2bv((t1_27[64:63]) == (t2_28[64:63]))), (XOR_1((t1_27[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_27)), t2_28)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_33,t1_21,t1_27,t2_22,t2_28,t_1,t_11,t_15,t_7,target_19,target_5;
