...
axiom _function_addr_low == 6432bv64;
axiom _function_addr_high == 6501bv64;
...
mem := STORE_LE_64(mem, RSP, 6456bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2020"} true;
call arbitrary_func();
...
label_0x1948:
RDX := LOAD_LE_64(mem, PLUS_64(RSP, 56bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 6487bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1da0"} true;
call arbitrary_func();
