...
axiom _function_addr_low == 5760bv64;
axiom _function_addr_high == 5868bv64;
...
label_0x16a0:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24089bv64, 5799bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5849bv64);
