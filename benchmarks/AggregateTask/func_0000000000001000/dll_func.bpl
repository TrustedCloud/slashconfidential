...
axiom _function_addr_high == 4263bv64;
...
label_0x1018:
RDX := LOAD_LE_64(mem, PLUS_64((PLUS_64(25761bv64, 4127bv64)), 0bv64));
...
label_0x1022:
origDEST_5 := RCX;
origCOUNT_6 := AND_64(9bv64, (MINUS_64(64bv64, 1bv64)));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_6 == 1bv64)), origDEST_5[64:63], unconstrained_3));
SF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), SF, RCX[64:63]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), ZF, bool2bv(0bv64 == RCX));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), PF, NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), AF, unconstrained_4);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_12 == 1bv64)), origDEST_11[64:63], unconstrained_5));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv64)), AF, unconstrained_6);

label_0x102a:
RCX := LOAD_LE_64(mem, PLUS_64(RDX, (LSHIFT_64(RCX, 3bv64))));
...
label_0x1035:
RAX := PLUS_64((PLUS_64(20748bv64, 4156bv64)), 0bv64)[64:0];

label_0x103c:
mem := STORE_LE_64(mem, R9, RAX);

label_0x103f:
RAX := PLUS_64(R9, 8bv64)[64:0];
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_22 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_22 == 1bv64)), origDEST_21[64:63], unconstrained_13));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_22 == 0bv64)), AF, unconstrained_14);

label_0x105a:
RCX := LOAD_LE_64(mem, PLUS_64(RDX, (LSHIFT_64(RAX, 3bv64))));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_28 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_28 == 1bv64)), origDEST_27[64:63], unconstrained_15));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_28 == 0bv64)), AF, unconstrained_16);
...
label_0x106d:
RAX := PLUS_64(R9, 16bv64)[64:0];

label_0x1071:
mem := STORE_LE_64(mem, PLUS_64(R9, 8bv64), R10);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_38 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_38 == 1bv64)), origDEST_37[64:63], unconstrained_23));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_38 == 0bv64)), AF, unconstrained_24);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_44 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_44 == 1bv64)), origDEST_43[64:63], unconstrained_25));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_44 == 0bv64)), AF, unconstrained_26);
...
label_0x10a2:
mem := STORE_LE_64(mem, PLUS_64(R9, 16bv64), R8);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R10,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_22,origCOUNT_28,origCOUNT_38,origCOUNT_44,origCOUNT_6,origDEST_11,origDEST_21,origDEST_27,origDEST_37,origDEST_43,origDEST_5,ra_49;
