...
axiom _function_addr_low == 14672bv64;
axiom _function_addr_high == 14831bv64;
...
label_0x3988:
RCX := PLUS_64((PLUS_64(1793bv64, 14735bv64)), 0bv64)[64:0];

label_0x398f:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 14740bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3760"} true;
call arbitrary_func();
...
label_0x39af:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(15114bv64, 14774bv64)), 0bv64));
