...
axiom _function_addr_low == 4368bv64;
axiom _function_addr_high == 4460bv64;
...
label_0x112e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(25483bv64, 4405bv64)), 0bv64));
...
label_0x114e:
RAX := PLUS_64((PLUS_64(20547bv64, 4437bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4451bv64);
