...
axiom _function_addr_high == 5158bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5039bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5061bv64);
...
label_0x13d9:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24800bv64, 5088bv64)), 0bv64));
...
label_0x13f9:
RAX := PLUS_64((PLUS_64(19824bv64, 5120bv64)), 0bv64)[64:0];
