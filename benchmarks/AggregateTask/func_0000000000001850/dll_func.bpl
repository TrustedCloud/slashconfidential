...
axiom _function_addr_low == 6224bv64;
axiom _function_addr_high == 6263bv64;
...
mem := STORE_LE_64(mem, RSP, 6258bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x5280"} true;
call arbitrary_func();
