...
axiom _function_addr_low == 6352bv64;
axiom _function_addr_high == 6438bv64;
...
label_0x18ef:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(23498bv64, 6390bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 6429bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1930"} true;
call arbitrary_func();
