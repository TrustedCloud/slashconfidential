...
axiom _function_addr_low == 14848bv64;
axiom _function_addr_high == 14979bv64;
...
label_0x3a13:
RBX := LOAD_LE_64(mem, PLUS_64((PLUS_64(15014bv64, 14874bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 14928bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3950"} true;
call arbitrary_func();
