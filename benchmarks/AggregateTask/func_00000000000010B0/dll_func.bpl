...
axiom _function_addr_high == 4364bv64;
...
label_0x10ce:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(25579bv64, 4309bv64)), 0bv64));
...
label_0x10ee:
RAX := PLUS_64((PLUS_64(20563bv64, 4341bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4355bv64);
