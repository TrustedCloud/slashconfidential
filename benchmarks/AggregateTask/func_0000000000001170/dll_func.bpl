...
axiom _function_addr_low == 4464bv64;
axiom _function_addr_high == 4556bv64;
...
label_0x118e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(25387bv64, 4501bv64)), 0bv64));
...
label_0x11ae:
RAX := PLUS_64((PLUS_64(20563bv64, 4533bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4547bv64);
