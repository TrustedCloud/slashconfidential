...
axiom _function_addr_low == 6304bv64;
axiom _function_addr_high == 6320bv64;
...
mem := STORE_LE_64(mem, RSP, 6313bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3cd0"} true;
call arbitrary_func();
