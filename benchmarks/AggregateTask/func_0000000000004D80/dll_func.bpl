...
axiom _function_addr_low == 19840bv64;
axiom _function_addr_high == 20704bv64;
...
label_0x4dc4:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(9973bv64, 19915bv64)), 0bv64));
...
label_0x4e11:
RSI := LOAD_LE_64(mem, PLUS_64((PLUS_64(9896bv64, 19992bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 20212bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 20641bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x39f0"} true;
call arbitrary_func();
