...
axiom _function_addr_low == 19088bv64;
axiom _function_addr_high == 19459bv64;
...
label_0x4abc:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(10749bv64, 19139bv64)), 0bv64));
...
label_0x4afd:
RDI := LOAD_LE_64(mem, PLUS_64((PLUS_64(10684bv64, 19204bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 19343bv64);
