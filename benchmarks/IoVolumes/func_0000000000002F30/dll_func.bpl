...
axiom _function_addr_low == 12080bv64;
axiom _function_addr_high == 12119bv64;
...
label_0x2f34:
RAX := LOAD_LE_64(mem, PLUS_64(RCX, 96bv64));

label_0x2f38:
R9 := LOAD_LE_64(mem, PLUS_64(RCX, 88bv64));

label_0x2f3c:
R8 := LOAD_LE_64(mem, PLUS_64(RCX, 112bv64));

label_0x2f40:
RDX := LOAD_LE_64(mem, PLUS_64(RCX, 104bv64));
...
mem := STORE_LE_64(mem, RSP, 12114bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x5160"} true;
call arbitrary_func();
