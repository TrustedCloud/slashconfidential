...
axiom _function_addr_low == 11504bv64;
axiom _function_addr_high == 11614bv64;
...
label_0x2d08:
RDX := LOAD_LE_64(mem, PLUS_64((PLUS_64(17601bv64, 11535bv64)), 0bv64));
...
label_0x2d59:
mem := STORE_LE_64(mem, PLUS_64(R9, 8bv64), R8);
