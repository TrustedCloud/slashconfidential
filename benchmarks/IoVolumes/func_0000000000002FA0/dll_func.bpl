...
axiom _function_addr_low == 12192bv64;
axiom _function_addr_high == 12199bv64;
...
label_0x2fa2:
assert {:SlashVerifyCommandType "remotejmp"} {:SlashVerifyJmpTarget "0x4fa0"} true;
return;

}

procedure dll_func();
  modifies AF,CF,OF,PF,RDX,SF,ZF;
