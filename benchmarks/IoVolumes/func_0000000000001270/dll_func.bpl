...
axiom _function_addr_low == 4720bv64;
axiom _function_addr_high == 4812bv64;
...
label_0x128e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24379bv64, 4757bv64)), 0bv64));
...
label_0x12ae:
RAX := PLUS_64((PLUS_64(20187bv64, 4789bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4803bv64);
