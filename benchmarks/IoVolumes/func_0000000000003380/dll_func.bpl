...
axiom _function_addr_low == 13184bv64;
axiom _function_addr_high == 13267bv64;
...
label_0x3380:
R10 := LOAD_LE_64(mem, PLUS_64(RCX, 32bv64));
...
label_0x338c:
R11 := LOAD_LE_64(mem, R10);

label_0x338f:
RAX := PLUS_64(RCX, 32bv64)[64:0];
...
label_0x33a2:
RDX := PLUS_64(RCX, 32bv64)[64:0];

label_0x33a6:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(15907bv64, 13229bv64)), 0bv64));

label_0x33ad:
origDEST_9 := RDX;
origCOUNT_10 := AND_64(9bv64, (MINUS_64(64bv64, 1bv64)));
RDX := RSHIFT_64(RDX, (AND_64(9bv64, (MINUS_64(64bv64, 1bv64)))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_10 == 0bv64)), CF, LSHIFT_64(origDEST_9, (MINUS_64(64bv64, origCOUNT_10)))[64:63]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_10 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_10 == 1bv64)), origDEST_9[64:63], unconstrained_4));
SF := ITE_1(bv2bool(bool2bv(origCOUNT_10 == 0bv64)), SF, RDX[64:63]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_10 == 0bv64)), ZF, bool2bv(0bv64 == RDX));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_10 == 0bv64)), PF, NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)), 2bv64)), (XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)), 2bv64)), (XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_10 == 0bv64)), AF, unconstrained_5);

label_0x33b1:
R8 := LOAD_LE_64(mem, PLUS_64(RCX, (LSHIFT_64(RDX, 3bv64))));

label_0x33b5:
RCX := PLUS_64(R9, 32bv64)[64:0];
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_16 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_16 == 1bv64)), origDEST_15[64:63], unconstrained_6));
SF := ITE_1(bv2bool(bool2bv(origCOUNT_16 == 0bv64)), SF, RCX[64:63]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_16 == 0bv64)), ZF, bool2bv(0bv64 == RCX));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_16 == 0bv64)), PF, NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_16 == 0bv64)), AF, unconstrained_7);
...
label_0x33c4:
RCX := LOAD_LE_64(mem, PLUS_64(R10, 8bv64));

label_0x33c8:
RAX := R11;

label_0x33cb:
mem := STORE_LE_64(mem, PLUS_64(R9, 32bv64), RCX);

label_0x33cf:

ra_21 := LOAD_LE_64(mem, RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R10,R11,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_10,origCOUNT_16,origDEST_15,origDEST_9,ra_21,ra_23,t_1;
