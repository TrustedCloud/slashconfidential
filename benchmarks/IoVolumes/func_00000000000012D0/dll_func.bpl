...
axiom _function_addr_high == 4908bv64;
...
label_0x12ee:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24283bv64, 4853bv64)), 0bv64));
...
label_0x130e:
RAX := PLUS_64((PLUS_64(20203bv64, 4885bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4899bv64);
