...
axiom _function_addr_low == 4384bv64;
axiom _function_addr_high == 4561bv64;
...
label_0x113f:
RDI := LOAD_LE_64(mem, PLUS_64((PLUS_64(24714bv64, 4422bv64)), 0bv64));
...
label_0x115c:
RAX := PLUS_64((PLUS_64(20717bv64, 4451bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4462bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2520"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4475bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4483bv64);
...
label_0x1188:
RCX := LOAD_LE_64(mem, PLUS_64(RBX, 24bv64));

label_0x118c:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4497bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2f70"} true;
call arbitrary_func();
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_42 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_42 == 1bv64)), origDEST_41[64:63], unconstrained_17));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_42 == 0bv64)), AF, unconstrained_18);
...
label_0x11bc:
RAX := PLUS_64((PLUS_64(20421bv64, 4547bv64)), 0bv64)[64:0];
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RBX,RCX,RDI,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origCOUNT_36,origCOUNT_42,origDEST_11,origDEST_17,origDEST_35,origDEST_41,ra_53,t1_47,t2_48,t_1,t_23,t_27,t_3;
