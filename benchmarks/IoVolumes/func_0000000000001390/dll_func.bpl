...
axiom _function_addr_high == 5105bv64;
...
label_0x1390:
RAX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, RCX)));

label_0x1393:
R9 := RCX;

label_0x1396:
t_1 := MINUS_8((RAX[32:0][8:0]), 44bv8);
CF := bool2bv(LT_8((RAX[32:0][8:0]), 44bv8));
OF := AND_8((XOR_8((RAX[32:0][8:0]), 44bv8)), (XOR_8((RAX[32:0][8:0]), t_1)))[8:7];
AF := bool2bv(16bv8 == (AND_8(16bv8, (XOR_8((XOR_8(t_1, (RAX[32:0][8:0]))), 44bv8)))));
...
label_0x13a0:
t_5 := AND_8((RAX[32:0][8:0]), (RAX[32:0][8:0]));
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_1;
...
label_0x13a4:
RAX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, PLUS_64(R9, 1bv64))));

label_0x13a9:
t_9 := R9;
R9 := PLUS_64(R9, 1bv64);
OF := AND_1((bool2bv((t_9[64:63]) == (1bv64[64:63]))), (XOR_1((t_9[64:63]), (R9[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(R9, t_9)), 1bv64)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(R9, 4bv64)), R9)), 2bv64)), (XOR_64((RSHIFT_64(R9, 4bv64)), R9)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(R9, 4bv64)), R9)), 2bv64)), (XOR_64((RSHIFT_64(R9, 4bv64)), R9)))))[1:0]));
SF := R9[64:63];
ZF := bool2bv(0bv64 == R9);

label_0x13ac:
t_13 := MINUS_8((RAX[32:0][8:0]), 44bv8);
CF := bool2bv(LT_8((RAX[32:0][8:0]), 44bv8));
OF := AND_8((XOR_8((RAX[32:0][8:0]), 44bv8)), (XOR_8((RAX[32:0][8:0]), t_13)))[8:7];
AF := bool2bv(16bv8 == (AND_8(16bv8, (XOR_8((XOR_8(t_13, (RAX[32:0][8:0]))), 44bv8)))));
PF := NOT_1((XOR_8((RSHIFT_8((XOR_8((RSHIFT_8((XOR_8((RSHIFT_8(t_13, 4bv8)), t_13)), 2bv8)), (XOR_8((RSHIFT_8(t_13, 4bv8)), t_13)))), 1bv8)), (XOR_8((RSHIFT_8((XOR_8((RSHIFT_8(t_13, 4bv8)), t_13)), 2bv8)), (XOR_8((RSHIFT_8(t_13, 4bv8)), t_13)))))[1:0]));
SF := t_13[8:7];
ZF := bool2bv(0bv8 == t_13);
...
label_0x13b0:
t_17 := MINUS_8((LOAD_LE_8(mem, R9)), 48bv8);
CF := bool2bv(LT_8((LOAD_LE_8(mem, R9)), 48bv8));
OF := AND_8((XOR_8((LOAD_LE_8(mem, R9)), 48bv8)), (XOR_8((LOAD_LE_8(mem, R9)), t_17)))[8:7];
AF := bool2bv(16bv8 == (AND_8(16bv8, (XOR_8((XOR_8(t_17, (LOAD_LE_8(mem, R9)))), 48bv8)))));
...
label_0x13c8:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24065bv64, 5071bv64)), 0bv64));
...
RDX := RSHIFT_64(RDX, (AND_64(9bv64, (MINUS_64(64bv64, 1bv64)))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_26 == 0bv64)), CF, LSHIFT_64(origDEST_25, (MINUS_64(64bv64, origCOUNT_26)))[64:63]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_26 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_26 == 1bv64)), origDEST_25[64:63], unconstrained_4));
SF := ITE_1(bv2bool(bool2bv(origCOUNT_26 == 0bv64)), SF, RDX[64:63]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_26 == 0bv64)), ZF, bool2bv(0bv64 == RDX));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_26 == 0bv64)), PF, NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)), 2bv64)), (XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)), 2bv64)), (XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_26 == 0bv64)), AF, unconstrained_5);

label_0x13d6:
R8 := LOAD_LE_64(mem, PLUS_64(RCX, (LSHIFT_64(RDX, 3bv64))));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_32 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_32 == 1bv64)), origDEST_31[64:63], unconstrained_6));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_32 == 0bv64)), AF, unconstrained_7);

label_0x13e1:
CF := RSHIFT_64(R8, (AND_64(RCX, 63bv64)))[1:0];
OF := unconstrained_8;
SF := unconstrained_9;
AF := unconstrained_10;
PF := unconstrained_11;
...
label_0x13e8:
mem := STORE_LE_8(mem, R9, 0bv8);

label_0x13ec:
RAX := PLUS_64(R9, 1bv64)[64:0];
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_26,origCOUNT_32,origDEST_25,origDEST_31,ra_37,t_1,t_13,t_17,t_5,t_9;
