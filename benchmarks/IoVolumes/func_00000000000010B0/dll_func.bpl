...
axiom _function_addr_low == 4272bv64;
axiom _function_addr_high == 4382bv64;
...
label_0x10c8:
RDX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24833bv64, 4303bv64)), 0bv64));
...
label_0x1119:
mem := STORE_LE_8(mem, PLUS_64(R9, 8bv64), R8[32:0][8:0]);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R10,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_22,origCOUNT_28,origCOUNT_6,origDEST_11,origDEST_21,origDEST_27,origDEST_5,ra_33;
