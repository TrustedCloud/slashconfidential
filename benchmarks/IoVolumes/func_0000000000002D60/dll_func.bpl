...
axiom _function_addr_low == 11616bv64;
axiom _function_addr_high == 11724bv64;
...
label_0x2d80:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(17481bv64, 11655bv64)), 0bv64));

label_0x2d87:
RDX := PLUS_64(RCX, 24bv64)[64:0];
...
label_0x2d8f:
R8 := LOAD_LE_64(mem, PLUS_64(RAX, (LSHIFT_64(RDX, 3bv64))));
...
label_0x2da2:
RAX := LOAD_LE_64(mem, RCX);

label_0x2da5:
mem := STORE_LE_64(mem, PLUS_64(RCX, 24bv64), 0bv64);

label_0x2dad:
RBX := LOAD_LE_64(mem, PLUS_64(RAX, 16bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 11705bv64);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RBX,RCX,RDI,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origDEST_11,origDEST_17,t1_23,t2_24,t_1,t_3;
