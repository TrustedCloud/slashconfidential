...
axiom _function_addr_low == 13856bv64;
axiom _function_addr_high == 14340bv64;
...
label_0x363b:
RBX := LOAD_LE_64(mem, PLUS_64((PLUS_64(15246bv64, 13890bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 14061bv64);
...
target_71 := RBP;
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 14087bv64);
