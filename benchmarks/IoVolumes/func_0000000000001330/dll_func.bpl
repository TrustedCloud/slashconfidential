...
axiom _function_addr_low == 4912bv64;
axiom _function_addr_high == 5004bv64;
...
label_0x134e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24187bv64, 4949bv64)), 0bv64));
...
label_0x136e:
RAX := PLUS_64((PLUS_64(19987bv64, 4981bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4995bv64);
