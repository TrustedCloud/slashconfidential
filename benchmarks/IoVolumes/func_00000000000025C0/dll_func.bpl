...
axiom _function_addr_low == 9664bv64;
axiom _function_addr_high == 9814bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9695bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 9717bv64);
...
label_0x2609:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(19392bv64, 9744bv64)), 0bv64));
...
label_0x2629:
RAX := PLUS_64((PLUS_64(15152bv64, 9776bv64)), 0bv64)[64:0];
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RBX,RCX,RDI,RDX,RSI,RSP,SF,ZF,mem,origCOUNT_16,origCOUNT_22,origDEST_15,origDEST_21,ra_33,ra_41,t1_27,t1_35,t2_28,t2_36,t_1,t_3,t_7;
