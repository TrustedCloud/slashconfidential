...
axiom _function_addr_low == 5120bv64;
axiom _function_addr_high == 5161bv64;
...
label_0x1400:
RAX := LOAD_LE_64(mem, RDX);

label_0x1403:
R9 := LOAD_LE_64(mem, R8);

label_0x1406:
t_1 := R9;
R9 := MINUS_64(R9, RAX);
CF := bool2bv(LT_64(t_1, RAX));
OF := AND_64((XOR_64(t_1, RAX)), (XOR_64(t_1, R9)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(R9, t_1)), RAX)))));
...
label_0x1410:
RDX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, RAX)));

label_0x1413:
RCX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, PLUS_64(RAX, R9))));

label_0x1418:
t_5 := RDX[32:0];
RDX := (0bv32 ++ MINUS_32((RDX[32:0]), (RCX[32:0])));
CF := bool2bv(LT_32(t_5, (RCX[32:0])));
OF := AND_32((XOR_32(t_5, (RCX[32:0]))), (XOR_32(t_5, (RDX[32:0]))))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32((RDX[32:0]), t_5)), (RCX[32:0]))))));
...
OF := AND_1((bool2bv((t_9[64:63]) == (1bv64[64:63]))), (XOR_1((t_9[64:63]), (RAX[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RAX, t_9)), 1bv64)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RAX, 4bv64)), RAX)), 2bv64)), (XOR_64((RSHIFT_64(RAX, 4bv64)), RAX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RAX, 4bv64)), RAX)), 2bv64)), (XOR_64((RSHIFT_64(RAX, 4bv64)), RAX)))))[1:0]));
SF := RAX[64:63];
ZF := bool2bv(0bv64 == RAX);

label_0x141f:
t_13 := AND_32((RCX[32:0]), (RCX[32:0]));
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_1;
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,ra_21,t_1,t_13,t_17,t_5,t_9;
