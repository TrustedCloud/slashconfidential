...
axiom _function_addr_low == 4624bv64;
axiom _function_addr_high == 4716bv64;
...
label_0x122e:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(24475bv64, 4661bv64)), 0bv64));
...
label_0x124e:
RAX := PLUS_64((PLUS_64(20195bv64, 4693bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4707bv64);
