...
axiom _function_addr_low == 4576bv64;
axiom _function_addr_high == 4623bv64;
...
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1120"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4609bv64);
