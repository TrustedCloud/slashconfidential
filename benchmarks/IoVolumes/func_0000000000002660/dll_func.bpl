...
axiom _function_addr_low == 9824bv64;
axiom _function_addr_high == 9863bv64;
...
mem := STORE_LE_64(mem, RSP, 9838bv64);
...
label_0x2673:
RCX := PLUS_64((PLUS_64(15182bv64, 9850bv64)), 0bv64)[64:0];
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_15,ra_23,t1_17,t1_9,t2_10,t2_18,t_1,t_5;
