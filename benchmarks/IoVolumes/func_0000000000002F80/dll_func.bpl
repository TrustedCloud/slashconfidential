...
axiom _function_addr_low == 12160bv64;
axiom _function_addr_high == 12176bv64;
...
mem := STORE_LE_64(mem, RSP, 12169bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3b90"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RSP,SF,ZF,mem,ra_11,t1_5,t2_6,t_1;
