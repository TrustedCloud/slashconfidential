...
axiom _function_addr_low == 11744bv64;
axiom _function_addr_high == 12072bv64;
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 11785bv64);
...
label_0x2e57:
R9 := LOAD_LE_64(mem, PLUS_64((PLUS_64(17266bv64, 11870bv64)), 0bv64));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 12028bv64);
...
label_0x2f04:
RDX := PLUS_64((PLUS_64(13201bv64, 12043bv64)), 0bv64)[64:0];
...
label_0x2f18:
assert {:SlashVerifyCommandType "remotejmp"} {:SlashVerifyJmpTarget "0x2cf0"} true;
return;
