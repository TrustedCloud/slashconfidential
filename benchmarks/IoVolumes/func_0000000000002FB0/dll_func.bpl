...
axiom _function_addr_low == 12208bv64;
axiom _function_addr_high == 12291bv64;
...
label_0x2fb6:
R8 := OR_64(R8, 4294967295bv32 ++ 4294967295bv32);
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_1;
...
t_3 := R8;
R8 := PLUS_64(R8, 1bv64);
OF := AND_1((bool2bv((t_3[64:63]) == (1bv64[64:63]))), (XOR_1((t_3[64:63]), (R8[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(R8, t_3)), 1bv64)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(R8, 4bv64)), R8)), 2bv64)), (XOR_64((RSHIFT_64(R8, 4bv64)), R8)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(R8, 4bv64)), R8)), 2bv64)), (XOR_64((RSHIFT_64(R8, 4bv64)), R8)))))[1:0]));
SF := R8[64:63];
ZF := bool2bv(0bv64 == R8);

label_0x2fc3:
t_7 := MINUS_8((LOAD_LE_8(mem, PLUS_64(RDX, R8))), 0bv8);
CF := bool2bv(LT_8((LOAD_LE_8(mem, PLUS_64(RDX, R8))), 0bv8));
OF := AND_8((XOR_8((LOAD_LE_8(mem, PLUS_64(RDX, R8))), 0bv8)), (XOR_8((LOAD_LE_8(mem, PLUS_64(RDX, R8))), t_7)))[8:7];
AF := bool2bv(16bv8 == (AND_8(16bv8, (XOR_8((XOR_8(t_7, (LOAD_LE_8(mem, PLUS_64(RDX, R8))))), 0bv8)))));
...
label_0x2fca:
RDX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, R10)));
...
label_0x2fd2:
t_11 := AND_8((RDX[32:0][8:0]), (RDX[32:0][8:0]));
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_4;
...
label_0x2fd6:
t_15 := MINUS_8((RDX[32:0][8:0]), (LOAD_LE_8(mem, PLUS_64(RAX, R9))));
CF := bool2bv(LT_8((RDX[32:0][8:0]), (LOAD_LE_8(mem, PLUS_64(RAX, R9)))));
OF := AND_8((XOR_8((RDX[32:0][8:0]), (LOAD_LE_8(mem, PLUS_64(RAX, R9))))), (XOR_8((RDX[32:0][8:0]), t_15)))[8:7];
AF := bool2bv(16bv8 == (AND_8(16bv8, (XOR_8((XOR_8(t_15, (RDX[32:0][8:0]))), (LOAD_LE_8(mem, PLUS_64(RAX, R9))))))));
...
label_0x2fe3:
t_23 := MINUS_64(RAX, R8);
CF := bool2bv(LT_64(RAX, R8));
OF := AND_64((XOR_64(RAX, R8)), (XOR_64(RAX, t_23)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_23, RAX)), R8)))));
...
label_0x2fe8:
RDX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, PLUS_64((PLUS_64(RCX, R10)), 1bv64))));

label_0x2fee:
t_27 := RCX;
RCX := PLUS_64(RCX, 1bv64);
OF := AND_1((bool2bv((t_27[64:63]) == (1bv64[64:63]))), (XOR_1((t_27[64:63]), (RCX[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RCX, t_27)), 1bv64)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))))[1:0]));
SF := RCX[64:63];
ZF := bool2bv(0bv64 == RCX);

label_0x2ff1:
t_31 := AND_8((RDX[32:0][8:0]), (RDX[32:0][8:0]));
OF := 0bv1;
CF := 0bv1;
AF := unconstrained_6;
...
CF := bool2bv(LT_64(t_37, RAX));
OF := AND_64((XOR_64(t_37, RAX)), (XOR_64(t_37, RCX)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RCX, t_37)), RAX)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)), 2bv64)), (XOR_64((RSHIFT_64(RCX, 4bv64)), RCX)))))[1:0]));
SF := RCX[64:63];
ZF := bool2bv(0bv64 == RCX);

label_0x2ffb:
RAX := PLUS_64(R10, 1bv64)[64:0];
...
procedure dll_func();
  modifies AF,CF,OF,PF,R10,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,ra_35,ra_47,t1_41,t2_42,t_11,t_15,t_19,t_23,t_27,t_3,t_31,t_37,t_7;
