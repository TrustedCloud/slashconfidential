...
axiom _function_addr_low == 12304bv64;
axiom _function_addr_high == 12390bv64;
...
label_0x302f:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(16794bv64, 12342bv64)), 0bv64));

label_0x3036:
R8 := PLUS_64(RCX, 8bv64)[64:0];
...
label_0x3054:
mem := STORE_LE_8(mem, PLUS_64(RCX, 8bv64), 0bv8);

label_0x3058:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 12381bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3070"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RBX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origDEST_11,origDEST_17,ra_29,t1_23,t2_24,t_1,t_3;
