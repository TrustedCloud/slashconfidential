...
axiom _function_addr_low == 9504bv64;
axiom _function_addr_high == 9625bv64;
...
label_0x2536:
R8 := LOAD_LE_64(mem, PLUS_64((PLUS_64(19603bv64, 9533bv64)), 0bv64));

label_0x253d:
RAX := PLUS_64(RDX, 40bv64)[64:0];

label_0x2541:
t1_5 := RCX;
t2_6 := 40bv64;
RCX := PLUS_64(RCX, t2_6);
CF := bool2bv(LT_64(RCX, t1_5));
OF := AND_1((bool2bv((t1_5[64:63]) == (t2_6[64:63]))), (XOR_1((t1_5[64:63]), (RCX[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RCX, t1_5)), t2_6)))));
...
label_0x254d:
RCX := LOAD_LE_64(mem, PLUS_64(R8, (LSHIFT_64(RCX, 3bv64))));
...
label_0x2565:
mem := STORE_LE_32(mem, PLUS_64(RDX, 40bv64), R9[32:0]);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_28 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_28 == 1bv64)), origDEST_27[64:63], unconstrained_14));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_28 == 0bv64)), AF, unconstrained_15);

label_0x257a:
RCX := LOAD_LE_64(mem, PLUS_64(R8, (LSHIFT_64(RAX, 3bv64))));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_34 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_34 == 1bv64)), origDEST_33[64:63], unconstrained_16));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_34 == 0bv64)), AF, unconstrained_17);
...
label_0x2590:
mem := STORE_LE_64(mem, PLUS_64(RDX, 32bv64), R9);

label_0x2594:
assert {:SlashVerifyCommandType "remotejmp"} {:SlashVerifyJmpTarget "0x2760"} true;
return;

}

procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,SF,ZF,mem,origCOUNT_12,origCOUNT_18,origCOUNT_28,origCOUNT_34,origDEST_11,origDEST_17,origDEST_27,origDEST_33,t1_5,t2_6;
