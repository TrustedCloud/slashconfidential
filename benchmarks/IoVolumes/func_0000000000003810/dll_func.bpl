...
axiom _function_addr_low == 14352bv64;
axiom _function_addr_high == 14511bv64;
...
label_0x3812:
t_3 := RSP;
RSP := MINUS_64(RSP, 48bv64);
CF := bool2bv(LT_64(t_3, 48bv64));
OF := AND_64((XOR_64(t_3, 48bv64)), (XOR_64(t_3, RSP)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t_3)), 48bv64)))));
...
label_0x3848:
RCX := PLUS_64((PLUS_64(1793bv64, 14415bv64)), 0bv64)[64:0];

label_0x384f:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 14420bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x3620"} true;
call arbitrary_func();
...
label_0x386f:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(14682bv64, 14454bv64)), 0bv64));
...
label_0x3895:
t_41 := MINUS_32((R8[32:0]), 4294967294bv32);
CF := bool2bv(LT_32((R8[32:0]), 4294967294bv32));
OF := AND_32((XOR_32((R8[32:0]), 4294967294bv32)), (XOR_32((R8[32:0]), t_41)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_41, (R8[32:0]))), 4294967294bv32)))));
...
label_0x3899:
R8 := (0bv32 ++ ITE_32(bv2bool(ZF), RAX[32:0], R8[32:0]));
...
t1_45 := RSP;
t2_46 := 48bv64;
RSP := PLUS_64(RSP, t2_46);
CF := bool2bv(LT_64(RSP, t1_45));
OF := AND_1((bool2bv((t1_45[64:63]) == (t2_46[64:63]))), (XOR_1((t1_45[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_45)), t2_46)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RBX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_28,origCOUNT_34,origDEST_27,origDEST_33,ra_51,ra_61,t1_45,t1_55,t2_46,t2_56,t_1,t_11,t_15,t_19,t_3,t_41,t_7;
