...
axiom _function_addr_low == 9872bv64;
axiom _function_addr_high == 9980bv64;
...
mem := STORE_LE_64(mem, RSP, 9886bv64);
...
label_0x26bf:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(19210bv64, 9926bv64)), 0bv64));
...
label_0x26dd:
RAX := PLUS_64((PLUS_64(15148bv64, 9956bv64)), 0bv64)[64:0];

label_0x26e4:
mem := STORE_LE_32(mem, PLUS_64(R8, 8bv64), 1000bv32);

label_0x26ec:
mem := STORE_LE_64(mem, R8, RAX);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_14,origCOUNT_20,origDEST_13,origDEST_19,ra_31,ra_39,t1_25,t1_33,t2_26,t2_34,t_1,t_5;
