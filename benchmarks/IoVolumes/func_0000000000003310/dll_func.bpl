...
axiom _function_addr_low == 13072bv64;
axiom _function_addr_high == 13158bv64;
...
label_0x3310:
R9 := LOAD_LE_64(mem, PLUS_64(RCX, 16bv64));
...
label_0x332a:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(16031bv64, 13105bv64)), 0bv64));
...
SF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), SF, RDX[64:63]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), ZF, bool2bv(0bv64 == RDX));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), PF, NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)), 2bv64)), (XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)), 2bv64)), (XOR_64((RSHIFT_64(RDX, 4bv64)), RDX)))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), AF, unconstrained_4);

label_0x3339:
RCX := LOAD_LE_64(mem, PLUS_64(RAX, (LSHIFT_64(RDX, 3bv64))));
...
label_0x334c:
t_17 := MINUS_32((LOAD_LE_32(mem, PLUS_64(R8, 8bv64))), 0bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(R8, 8bv64))), 0bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(R8, 8bv64))), 0bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(R8, 8bv64))), t_17)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_17, (LOAD_LE_32(mem, PLUS_64(R8, 8bv64))))), 0bv32)))));
...
label_0x3351:
mem := STORE_LE_64(mem, PLUS_64(R8, 32bv64), R9);
...
label_0x335a:
RCX := LOAD_LE_64(mem, PLUS_64(R9, 8bv64));

label_0x335e:
mem := STORE_LE_64(mem, PLUS_64(R8, 32bv64), RCX);

label_0x3362:
RAX := LOAD_LE_64(mem, R9);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origCOUNT_6,origDEST_11,origDEST_5,ra_21,ra_23,t_17;
