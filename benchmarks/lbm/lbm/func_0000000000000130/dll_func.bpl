...
axiom _function_addr_low == 304bv64;
axiom _function_addr_high == 448bv64;
...
label_0x139:
mem := STORE_LE_64(mem, PLUS_64(RSP, 32bv64), 400000bv64);
...
CF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), CF, RSHIFT_64(origDEST_5, (MINUS_64(64bv64, origCOUNT_6)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_6 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_6 == 1bv64)), XOR_1((RAX[64:63]), CF), unconstrained_1));
...
CF := bool2bv(LT_64(t_11, RAX));
OF := AND_64((XOR_64(t_11, RAX)), (XOR_64(t_11, RCX)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RCX, t_11)), RAX)))));
...
mem := STORE_LE_64(mem, RSP, 353bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x161"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,origCOUNT_22,origCOUNT_28,origCOUNT_6,origDEST_21,origDEST_27,origDEST_5,ra_39,t1_33,t2_34,t_1,t_11,t_17;
