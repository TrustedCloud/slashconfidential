...
axiom _function_addr_low == 11280bv64;
axiom _function_addr_high == 11405bv64;
...
label_0x2c19:
RAX := PLUS_64((PLUS_64(1072bv64, 11296bv64)), 0bv64)[64:0];

label_0x2c20:
RCX := PLUS_64((PLUS_64(1057bv64, 11303bv64)), 0bv64)[64:0];

label_0x2c27:
t_5 := MINUS_64(RAX, RCX);
CF := bool2bv(LT_64(RAX, RCX));
OF := AND_64((XOR_64(RAX, RCX)), (XOR_64(RAX, t_5)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_5, RAX)), RCX)))));
...
label_0x2c2d:
RAX := PLUS_64((PLUS_64(1044bv64, 11316bv64)), 0bv64)[64:0];
...
label_0x2c4d:
RAX := PLUS_64((PLUS_64(1020bv64, 11348bv64)), 0bv64)[64:0];

label_0x2c54:
t_21 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))), RAX);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))), RAX));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))), RAX)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))), t_21)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_21, (LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))))), RAX)))));
...
label_0x2c60:
t_25 := MINUS_32((LOAD_LE_32(mem, RAX)), 0bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, RAX)), 0bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, RAX)), 0bv32)), (XOR_32((LOAD_LE_32(mem, RAX)), t_25)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_25, (LOAD_LE_32(mem, RAX)))), 0bv32)))));
...
t1_29 := RDX;
t2_30 := RCX;
RDX := PLUS_64(RDX, t2_30);
CF := bool2bv(LT_64(RDX, t1_29));
OF := AND_1((bool2bv((t1_29[64:63]) == (t2_30[64:63]))), (XOR_1((t1_29[64:63]), (RDX[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RDX, t1_29)), t2_30)))));
...
mem := STORE_LE_64(mem, RSP, 11398bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1b40"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_41,t1_15,t1_29,t1_35,t1_9,t2_10,t2_16,t2_30,t2_36,t_1,t_21,t_25,t_5;
