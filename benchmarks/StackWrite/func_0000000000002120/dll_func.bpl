...
axiom _function_addr_high == 8613bv64;
...
label_0x2143:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(3814bv64, 8522bv64)), 0bv64));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_44 == 0bv32)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_44 == 1bv32)), XOR_1((RCX[32:0][32:31]), CF), unconstrained_14));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_44 == 0bv32)), AF, unconstrained_15);
