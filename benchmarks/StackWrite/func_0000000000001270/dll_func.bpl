...
axiom _function_addr_high == 4755bv64;
...
label_0x1282:
RCX := PLUS_64((PLUS_64(4294967295bv32 ++ 4294962551bv32, 4745bv64)), 0bv64)[64:0];

label_0x1289:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4750bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x15f0"} true;
call arbitrary_func();
