...
axiom _function_addr_low == 10624bv64;
axiom _function_addr_high == 10658bv64;
...
mem := STORE_LE_64(mem, RSP, 10653bv64);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RCX,RDX,RSP,SF,ZF,mem,ra_11,t1_5,t2_6,t_1;
