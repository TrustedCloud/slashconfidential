...
axiom _function_addr_high == 5310bv64;
...
mem := STORE_LE_64(mem, RSP, 5119bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x12b0"} true;
call arbitrary_func();
...
target_5 := LOAD_LE_64(mem, PLUS_64((PLUS_64(7150bv64, 5146bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5146bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5188bv64);
...
target_11 := LOAD_LE_64(mem, PLUS_64((PLUS_64(7077bv64, 5219bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5219bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5261bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1780"} true;
call arbitrary_func();
...
label_0x1491:
RDX := PLUS_64((PLUS_64(56bv64, 5272bv64)), 0bv64)[64:0];
...
target_17 := LOAD_LE_64(mem, PLUS_64((PLUS_64(7029bv64, 5283bv64)), 0bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5283bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 5300bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1780"} true;
call arbitrary_func();
