...
axiom _function_addr_low == 10448bv64;
axiom _function_addr_high == 10510bv64;
...
mem := STORE_LE_64(mem, RSP, 10457bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2af0"} true;
call arbitrary_func();

label_0x28d9:
RAX := LOAD_LE_64(mem, PLUS_64(RAX, 16bv64));

label_0x28dd:
mem := STORE_LE_64(mem, PLUS_64(RSP, 32bv64), RAX);

label_0x28e2:
RAX := PLUS_64(RSP, 56bv64)[64:0];
...
CF := bool2bv(LT_64(t_5, RAX));
OF := AND_64((XOR_64(t_5, RAX)), (XOR_64(t_5, RCX)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RCX, t_5)), RAX)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 10505bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1b80"} true;
call arbitrary_func();
