...
axiom _function_addr_low == 9264bv64;
axiom _function_addr_high == 9390bv64;
...
label_0x2443:
origDEST_5 := RAX;
origCOUNT_6 := AND_64(3bv64, (MINUS_64(64bv64, 1bv64)));
...
mem := STORE_LE_64(mem, RSP, 9311bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x23c0"} true;
call arbitrary_func();
...
label_0x2464:
origDEST_13 := RAX;
origCOUNT_14 := AND_64(RCX, (MINUS_64(64bv64, 1bv64)));
RAX := LSHIFT_64(RAX, (AND_64(RCX, (MINUS_64(64bv64, 1bv64)))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_14 == 0bv64)), CF, RSHIFT_64(origDEST_13, (MINUS_64(64bv64, origCOUNT_14)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_14 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_14 == 1bv64)), XOR_1((RAX[64:63]), CF), unconstrained_4));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_20 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_20 == 1bv64)), origDEST_19[64:63], unconstrained_6));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_20 == 0bv64)), AF, unconstrained_7);
...
label_0x247f:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(3002bv64, 9350bv64)), 0bv64));

label_0x2486:
t1_25 := RCX;
t2_26 := RAX;
RCX := PLUS_64(RCX, t2_26);
CF := bool2bv(LT_64(RCX, t1_25));
OF := AND_1((bool2bv((t1_25[64:63]) == (t2_26[64:63]))), (XOR_1((t1_25[64:63]), (RCX[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RCX, t1_25)), t2_26)))));
...
label_0x24a1:
t_33 := MINUS_64(RAX, (LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))));
CF := bool2bv(LT_64(RAX, (LOAD_LE_64(mem, PLUS_64(RSP, 32bv64)))));
OF := AND_64((XOR_64(RAX, (LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))))), (XOR_64(RAX, t_33)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_33, RAX)), (LOAD_LE_64(mem, PLUS_64(RSP, 32bv64))))))));
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_14,origCOUNT_20,origCOUNT_6,origDEST_13,origDEST_19,origDEST_5,ra_43,t1_25,t1_37,t2_26,t2_38,t_1,t_33;
