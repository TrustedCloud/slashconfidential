...
axiom _function_addr_low == 7216bv64;
axiom _function_addr_high == 7274bv64;
...
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1970"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 7269bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2550"} true;
call arbitrary_func();
