...
axiom _function_addr_low == 10704bv64;
axiom _function_addr_high == 10728bv64;
...
mem := STORE_LE_64(mem, RSP, 10723bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x2120"} true;
call arbitrary_func();
