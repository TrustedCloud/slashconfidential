...
axiom _function_addr_low == 4672bv64;
axiom _function_addr_high == 4712bv64;
...
mem := STORE_LE_64(mem, RSP, 4688bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1270"} true;
call arbitrary_func();

label_0x1250:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4693bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4705bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x12a0"} true;
call arbitrary_func();
