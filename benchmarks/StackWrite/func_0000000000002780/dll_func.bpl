...
axiom _function_addr_low == 10112bv64;
axiom _function_addr_high == 10179bv64;
...
label_0x2789:
RAX := LOAD_LE_64(mem, PLUS_64((PLUS_64(2224bv64, 10128bv64)), 0bv64));
...
label_0x27a7:
CF := RSHIFT_8((LOAD_LE_8(mem, PLUS_64(RAX, (RSHIFT_64(((0bv0 ++ RCX)), 3bv64))))), (AND_8(((0bv0 ++ RCX)[8:0]), 7bv8)))[1:0];
OF := unconstrained_1;
SF := unconstrained_2;
AF := unconstrained_3;
PF := unconstrained_4;
