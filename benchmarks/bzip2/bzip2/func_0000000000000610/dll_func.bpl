...
axiom _function_addr_low == 1552bv64;
axiom _function_addr_high == 1632bv64;
...
label_0x62a:
t_9 := MINUS_32((LOAD_LE_32(mem, RSP)), 8bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, RSP)), 8bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, RSP)), 8bv32)), (XOR_32((LOAD_LE_32(mem, RSP)), t_9)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_9, (LOAD_LE_32(mem, RSP)))), 8bv32)))));
