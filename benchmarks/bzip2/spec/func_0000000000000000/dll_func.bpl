...
axiom _function_addr_high == 48bv64;
...
label_0:
mem := STORE_LE_8(mem, PLUS_64((PLUS_64(0bv64, 6bv64)), 1bv64), 0bv8);

label_0x7:
mem := STORE_LE_32(mem, PLUS_64((PLUS_64(0bv64, 13bv64)), 4bv64), 0bv32);

label_0x11:
mem := STORE_LE_32(mem, PLUS_64((PLUS_64(0bv64, 23bv64)), 4bv64), 9bv32);

label_0x1b:
mem := STORE_LE_32(mem, PLUS_64((PLUS_64(0bv64, 33bv64)), 4bv64), 30bv32);
