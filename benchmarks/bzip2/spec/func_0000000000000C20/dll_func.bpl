...
axiom _function_addr_low == 3104bv64;
axiom _function_addr_high == 3392bv64;
...
label_0xc31:
RCX := PLUS_64((PLUS_64(0bv64, 3128bv64)), 0bv64)[64:0];

label_0xc38:
RAX := (ITE_64(bv2bool(LOAD_LE_32(mem, PLUS_64((PLUS_64(RCX, RAX)), 4bv64))[32:31]) ,(1bv32 ++ LOAD_LE_32(mem, PLUS_64((PLUS_64(RCX, RAX)), 4bv64))) ,(0bv32 ++ LOAD_LE_32(mem, PLUS_64((PLUS_64(RCX, RAX)), 4bv64)))));
...
label_0xc42:
t_7 := TIMES_128(((ITE_128(bv2bool(RCX[64:63]) ,(1bv64 ++ RCX) ,(0bv64 ++ RCX)))), ((ITE_128(bv2bool(24bv64[64:63]) ,(1bv64 ++ 24bv64) ,(0bv64 ++ 24bv64)))));
RCX := t_7[64:0];
OF := bool2bv(t_7 != ((ITE_128(bv2bool(RCX[64:63]) ,(1bv64 ++ RCX) ,(0bv64 ++ RCX)))));
CF := bool2bv(t_7 != ((ITE_128(bv2bool(RCX[64:63]) ,(1bv64 ++ RCX) ,(0bv64 ++ RCX)))));
PF := unconstrained_5;
SF := unconstrained_6;
ZF := unconstrained_7;
AF := unconstrained_8;
...
label_0xc46:
RDX := PLUS_64((PLUS_64(0bv64, 3149bv64)), 0bv64)[64:0];
...
label_0xc5c:
RCX := LOAD_LE_64(mem, PLUS_64((PLUS_64(RAX, RCX)), 16bv64));

label_0xc61:

RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 3174bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0xc66"} true;
call arbitrary_func();
...
label_0xc6f:
RCX := PLUS_64((PLUS_64(0bv64, 3190bv64)), 0bv64)[64:0];
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_30 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_30 == 1bv64)), origDEST_29[64:63], unconstrained_16));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_30 == 0bv64)), AF, unconstrained_17);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_36 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_36 == 1bv64)), origDEST_35[64:63], unconstrained_18));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_36 == 0bv64)), AF, unconstrained_19);
...
label_0xcd3:
RCX := PLUS_64((PLUS_64(0bv64, 3290bv64)), 0bv64)[64:0];
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_68 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_68 == 1bv64)), origDEST_67[64:63], unconstrained_32));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_68 == 0bv64)), AF, unconstrained_33);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_30,origCOUNT_36,origCOUNT_62,origCOUNT_68,origDEST_29,origDEST_35,origDEST_61,origDEST_67,ra_79,t1_11,t1_17,t1_43,t1_49,t1_73,t2_12,t2_18,t2_44,t2_50,t2_74,t_1,t_25,t_41,t_5,t_57,t_7,t_9;
