...
axiom _function_addr_low == 1264bv64;
axiom _function_addr_high == 1456bv64;
...
t1_53 := RSP;
t2_54 := 24bv64;
RSP := PLUS_64(RSP, t2_54);
CF := bool2bv(LT_64(RSP, t1_53));
OF := AND_1((bool2bv((t1_53[64:63]) == (t2_54[64:63]))), (XOR_1((t1_53[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_53)), t2_54)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,origCOUNT_18,origCOUNT_24,origCOUNT_42,origCOUNT_48,origDEST_17,origDEST_23,origDEST_41,origDEST_47,ra_59,t1_29,t1_5,t1_53,t2_30,t2_54,t2_6,t_1,t_13,t_37;
