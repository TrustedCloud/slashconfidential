...
axiom _function_addr_low == 57008bv64;
axiom _function_addr_high == 57072bv64;
...
mem := STORE_LE_64(mem, RSP, 57025bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0xdec1"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 57054bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0xdede"} true;
call arbitrary_func();
