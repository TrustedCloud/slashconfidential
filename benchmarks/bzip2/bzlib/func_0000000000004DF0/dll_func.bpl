...
axiom _function_addr_low == 19952bv64;
axiom _function_addr_high == 20048bv64;
...
label_0x4e24:
R9 := LOAD_LE_64(mem, PLUS_64(RSP, 104bv64));
...
mem := STORE_LE_64(mem, RSP, 20029bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x4e3d"} true;
call arbitrary_func();
