...
axiom _function_addr_low == 27152bv64;
axiom _function_addr_high == 27216bv64;
...
label_0x6a26:
t_5 := TIMES_64(((ITE_64(bv2bool(RAX[32:0][32:31]) ,(1bv32 ++ RAX[32:0]) ,(0bv32 ++ RAX[32:0])))), ((ITE_64(bv2bool(LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))[32:31]) ,(1bv32 ++ LOAD_LE_32(mem, PLUS_64(RSP, 80bv64))) ,(0bv32 ++ LOAD_LE_32(mem, PLUS_64(RSP, 80bv64)))))));
RAX := (0bv32 ++ t_5[32:0]);
OF := bool2bv(t_5 != ((ITE_64(bv2bool(RAX[32:0][32:31]) ,(1bv32 ++ RAX[32:0]) ,(0bv32 ++ RAX[32:0])))));
CF := bool2bv(t_5 != ((ITE_64(bv2bool(RAX[32:0][32:31]) ,(1bv32 ++ RAX[32:0]) ,(0bv32 ++ RAX[32:0])))));
PF := unconstrained_1;
SF := unconstrained_2;
ZF := unconstrained_3;
AF := unconstrained_4;
...
mem := STORE_LE_64(mem, RSP, 27189bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x6a35"} true;
call arbitrary_func();
...
t1_7 := RSP;
t2_8 := 56bv64;
RSP := PLUS_64(RSP, t2_8);
CF := bool2bv(LT_64(RSP, t1_7));
OF := AND_1((bool2bv((t1_7[64:63]) == (t2_8[64:63]))), (XOR_1((t1_7[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_7)), t2_8)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_13,t1_7,t2_8,t_1,t_5;
