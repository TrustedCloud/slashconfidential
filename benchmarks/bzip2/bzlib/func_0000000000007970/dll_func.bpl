...
axiom _function_addr_low == 31088bv64;
axiom _function_addr_high == 31152bv64;
...
label_0x797e:
t_5 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), 256bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), 256bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), 256bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), t_5)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_5, (LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))))), 256bv32)))));
...
mem := STORE_LE_64(mem, RSP, 31121bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x7991"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 31131bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x799b"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_15,t1_9,t2_10,t_1,t_5;
