...
axiom _function_addr_low == 28032bv64;
axiom _function_addr_high == 28080bv64;
...
label_0x6d8a:
t_1 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), 256bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), 256bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), 256bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))), t_1)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_1, (LOAD_LE_32(mem, PLUS_64(RAX, 92bv64))))), 256bv32)))));
...
label_0x6d98:
t_5 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RAX, 96bv64))), 0bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RAX, 96bv64))), 0bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RAX, 96bv64))), 0bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RAX, 96bv64))), t_5)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_5, (LOAD_LE_32(mem, PLUS_64(RAX, 96bv64))))), 0bv32)))));
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,ra_9,t_1,t_5;
