...
axiom _function_addr_low == 25344bv64;
axiom _function_addr_high == 25392bv64;
...
label_0x6311:
R8 := LOAD_LE_64(mem, PLUS_64(RSP, 56bv64));

label_0x6316:
RDX := (0bv32 ++ 4294967295bv32);
...
mem := STORE_LE_64(mem, RSP, 25381bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x6325"} true;
call arbitrary_func();
