...
axiom _function_addr_low == 26880bv64;
axiom _function_addr_high == 26992bv64;
...
mem := STORE_LE_64(mem, RSP, 26893bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x690d"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 26908bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x691c"} true;
call arbitrary_func();
...
label_0x6929:
RDX := PLUS_64((PLUS_64(0bv64, 26928bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 26936bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x6938"} true;
call arbitrary_func();

label_0x6938:
t_5 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 64bv64))), 1007bv32);
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 64bv64))), 1007bv32));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 64bv64))), 1007bv32)), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 64bv64))), t_5)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_5, (LOAD_LE_32(mem, PLUS_64(RSP, 64bv64))))), 1007bv32)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 26956bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x694c"} true;
call arbitrary_func();

label_0x694c:
RDX := PLUS_64((PLUS_64(0bv64, 26963bv64)), 0bv64)[64:0];
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 26971bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x695b"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 26978bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x6962"} true;
call arbitrary_func();

label_0x6962:
t1_9 := RSP;
t2_10 := 56bv64;
RSP := PLUS_64(RSP, t2_10);
CF := bool2bv(LT_64(RSP, t1_9));
OF := AND_1((bool2bv((t1_9[64:63]) == (t2_10[64:63]))), (XOR_1((t1_9[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_9)), t2_10)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,ra_15,t1_9,t2_10,t_1,t_5;
