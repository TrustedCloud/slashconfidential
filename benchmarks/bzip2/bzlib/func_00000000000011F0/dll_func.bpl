...
axiom _function_addr_low == 4592bv64;
axiom _function_addr_high == 5008bv64;
...
label_0x1249:
t_17 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RAX, 24bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RAX, 24bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 24bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 24bv64))), t_17)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_17, (LOAD_LE_64(mem, PLUS_64(RAX, 24bv64))))), 0bv64)))));
...
mem := STORE_LE_64(mem, RSP, 4712bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1268"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4734bv64);
...
label_0x1283:
t_23 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RAX, 32bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RAX, 32bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 32bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 32bv64))), t_23)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_23, (LOAD_LE_64(mem, PLUS_64(RAX, 32bv64))))), 0bv64)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4770bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x12a2"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4792bv64);
...
label_0x12bd:
t_29 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RAX, 40bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RAX, 40bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 40bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 40bv64))), t_29)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_29, (LOAD_LE_64(mem, PLUS_64(RAX, 40bv64))))), 0bv64)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4828bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x12dc"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4850bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4874bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x130a"} true;
call arbitrary_func();
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 4896bv64);
