...
axiom _function_addr_low == 27216bv64;
axiom _function_addr_high == 27264bv64;
...
label_0x6a5e:
t_5 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RSP, 56bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RSP, 56bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RSP, 56bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RSP, 56bv64))), t_5)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_5, (LOAD_LE_64(mem, PLUS_64(RSP, 56bv64))))), 0bv64)))));
...
mem := STORE_LE_64(mem, RSP, 27248bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x6a70"} true;
call arbitrary_func();
...
procedure dll_func();
  modifies AF,CF,OF,PF,RCX,RDX,RSP,SF,ZF,mem,ra_15,t1_9,t2_10,t_1,t_5;
