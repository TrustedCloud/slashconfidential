...
axiom _function_addr_low == 7904bv64;
axiom _function_addr_high == 8336bv64;
...
label_0x1ee9:
t_5 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RSP, 96bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RSP, 96bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RSP, 96bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RSP, 96bv64))), t_5)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_5, (LOAD_LE_64(mem, PLUS_64(RSP, 96bv64))))), 0bv64)))));
...
label_0x1f39:
t_17 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RAX, 3152bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RAX, 3152bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 3152bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 3152bv64))), t_17)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_17, (LOAD_LE_64(mem, PLUS_64(RAX, 3152bv64))))), 0bv64)))));
...
mem := STORE_LE_64(mem, RSP, 8027bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1f5b"} true;
call arbitrary_func();
...
label_0x1f60:
RDX := LOAD_LE_64(mem, PLUS_64(RAX, 3152bv64));
...
target_21 := LOAD_LE_64(mem, PLUS_64(RSP, 48bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8052bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "target_21"} true;
call arbitrary_func();
...
label_0x1f79:
t_23 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RAX, 3160bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RAX, 3160bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 3160bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 3160bv64))), t_23)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_23, (LOAD_LE_64(mem, PLUS_64(RAX, 3160bv64))))), 0bv64)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8091bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1f9b"} true;
call arbitrary_func();
...
label_0x1fa0:
RDX := LOAD_LE_64(mem, PLUS_64(RAX, 3160bv64));
...
target_27 := LOAD_LE_64(mem, PLUS_64(RSP, 56bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8116bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "target_27"} true;
call arbitrary_func();
...
label_0x1fb9:
t_29 := MINUS_64((LOAD_LE_64(mem, PLUS_64(RAX, 3168bv64))), 0bv64);
CF := bool2bv(LT_64((LOAD_LE_64(mem, PLUS_64(RAX, 3168bv64))), 0bv64));
OF := AND_64((XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 3168bv64))), 0bv64)), (XOR_64((LOAD_LE_64(mem, PLUS_64(RAX, 3168bv64))), t_29)))[64:63];
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(t_29, (LOAD_LE_64(mem, PLUS_64(RAX, 3168bv64))))), 0bv64)))));
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8155bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x1fdb"} true;
call arbitrary_func();
...
label_0x1fe0:
RDX := LOAD_LE_64(mem, PLUS_64(RAX, 3168bv64));
...
target_33 := LOAD_LE_64(mem, PLUS_64(RSP, 64bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8180bv64);
...
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8204bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x200c"} true;
call arbitrary_func();
...
label_0x2011:
RDX := LOAD_LE_64(mem, PLUS_64(RAX, 48bv64));
...
target_35 := LOAD_LE_64(mem, PLUS_64(RSP, 72bv64));
RSP := MINUS_64(RSP, 8bv64);
mem := STORE_LE_64(mem, RSP, 8226bv64);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_50 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_50 == 1bv64)), origDEST_49[64:63], unconstrained_3));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_50 == 0bv64)), AF, unconstrained_4);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_56 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_56 == 1bv64)), origDEST_55[64:63], unconstrained_5));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_56 == 0bv64)), AF, unconstrained_6);
...
t1_61 := RSP;
t2_62 := 88bv64;
RSP := PLUS_64(RSP, t2_62);
CF := bool2bv(LT_64(RSP, t1_61));
OF := AND_1((bool2bv((t1_61[64:63]) == (t2_62[64:63]))), (XOR_1((t1_61[64:63]), (RSP[64:63]))));
AF := bool2bv(16bv64 == (AND_64(16bv64, (XOR_64((XOR_64(RSP, t1_61)), t2_62)))));
PF := NOT_1((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))), 1bv64)), (XOR_64((RSHIFT_64((XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)), 2bv64)), (XOR_64((RSHIFT_64(RSP, 4bv64)), RSP)))))[1:0]));
SF := RSP[64:63];
ZF := bool2bv(0bv64 == RSP);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_50,origCOUNT_56,origDEST_49,origDEST_55,ra_67,t1_37,t1_61,t2_38,t2_62,t_1,t_13,t_17,t_23,t_29,t_45,t_5,t_9,target_21,target_27,target_33,target_35;
