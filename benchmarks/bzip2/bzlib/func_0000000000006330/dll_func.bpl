...
axiom _function_addr_low == 25392bv64;
axiom _function_addr_high == 25440bv64;
...
mem := STORE_LE_64(mem, RSP, 25427bv64);
assert {:SlashVerifyCommandType "call"} {:SlashVerifyCallTarget "0x6353"} true;
call arbitrary_func();
