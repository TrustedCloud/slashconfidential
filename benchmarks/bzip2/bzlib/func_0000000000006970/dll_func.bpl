...
axiom _function_addr_low == 26992bv64;
axiom _function_addr_high == 27104bv64;
...
label_0x6984:
mem := STORE_LE_32(mem, PLUS_64(RSP, 8bv64), 256bv32);
...
origCOUNT_12 := AND_32(1bv32, (MINUS_32(32bv32, 1bv32)));
RAX := (0bv32 ++ ARSHIFT_32((RAX[32:0]), (AND_32(1bv32, (MINUS_32(32bv32, 1bv32))))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv32)), CF, LSHIFT_32(origDEST_11, (MINUS_32(32bv32, origCOUNT_12)))[32:31]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_12 == 0bv32)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_12 == 1bv32)), 0bv1, unconstrained_1));
...
CF := bool2bv(LT_32(t_21, (RAX[32:0])));
OF := AND_32((XOR_32(t_21, (RAX[32:0]))), (XOR_32(t_21, (RCX[32:0]))))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32((RCX[32:0]), t_21)), (RAX[32:0]))))));
PF := NOT_1((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RCX[32:0]), 4bv32)), (RCX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RCX[32:0]), 4bv32)), (RCX[32:0]))))), 1bv32)), (XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RCX[32:0]), 4bv32)), (RCX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RCX[32:0]), 4bv32)), (RCX[32:0]))))))[1:0]));
SF := RCX[32:0][32:31];
ZF := bool2bv(0bv32 == (RCX[32:0]));
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_12,origDEST_11,ra_35,t1_29,t1_5,t2_30,t2_6,t_1,t_17,t_21,t_25;
