...
axiom _function_addr_low == 76816bv64;
axiom _function_addr_high == 77177bv64;
...
label_0x12c95:
RAX := (0bv32 ++ (0bv24 ++ LOAD_LE_8(mem, PLUS_64((PLUS_64(RCX, RAX)), 3196bv64))));
...
label_0x12cb5:
RCX := (ITE_64(bv2bool(LOAD_LE_32(mem, PLUS_64(RCX, 3192bv64))[32:31]) ,(1bv32 ++ LOAD_LE_32(mem, PLUS_64(RCX, 3192bv64))) ,(0bv32 ++ LOAD_LE_32(mem, PLUS_64(RCX, 3192bv64)))));
...
label_0x12d0e:
RAX := (0bv32 ++ LOAD_LE_32(mem, PLUS_64(RAX, 3192bv64)));
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_88 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_88 == 1bv64)), origDEST_87[64:63], unconstrained_24));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_88 == 0bv64)), AF, unconstrained_25);
...
OF := ITE_1(bv2bool(bool2bv(origCOUNT_94 == 0bv64)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_94 == 1bv64)), origDEST_93[64:63], unconstrained_26));
...
AF := ITE_1(bv2bool(bool2bv(origCOUNT_94 == 0bv64)), AF, unconstrained_27);
...
procedure dll_func();
  modifies AF,CF,OF,PF,RAX,RCX,RSP,SF,ZF,mem,origCOUNT_18,origCOUNT_24,origCOUNT_60,origCOUNT_66,origCOUNT_88,origCOUNT_94,origDEST_17,origDEST_23,origDEST_59,origDEST_65,origDEST_87,origDEST_93,ra_105,t1_41,t1_47,t1_5,t1_75,t1_99,t2_100,t2_42,t2_48,t2_6,t2_76,t_1,t_13,t_29,t_33,t_37,t_55,t_71,t_83;
