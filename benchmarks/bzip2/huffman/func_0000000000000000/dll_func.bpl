...
axiom _function_addr_high == 256bv64;
...
label_0x38:
t_9 := MINUS_32((LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))), (RAX[32:0]));
CF := bool2bv(LT_32((LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))), (RAX[32:0])));
OF := AND_32((XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))), (RAX[32:0]))), (XOR_32((LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))), t_9)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_9, (LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))))), (RAX[32:0]))))));
...
label_0x57:
t_17 := MINUS_32((LOAD_LE_32(mem, RSP)), (RAX[32:0]));
CF := bool2bv(LT_32((LOAD_LE_32(mem, RSP)), (RAX[32:0])));
OF := AND_32((XOR_32((LOAD_LE_32(mem, RSP)), (RAX[32:0]))), (XOR_32((LOAD_LE_32(mem, RSP)), t_17)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_17, (LOAD_LE_32(mem, RSP)))), (RAX[32:0]))))));
...
label_0x69:
t_21 := MINUS_32((RAX[32:0]), (LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))));
CF := bool2bv(LT_32((RAX[32:0]), (LOAD_LE_32(mem, PLUS_64(RSP, 8bv64)))));
OF := AND_32((XOR_32((RAX[32:0]), (LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))))), (XOR_32((RAX[32:0]), t_21)))[32:31];
AF := bool2bv(16bv32 == (AND_32(16bv32, (XOR_32((XOR_32(t_21, (RAX[32:0]))), (LOAD_LE_32(mem, PLUS_64(RSP, 8bv64))))))));
...
label_0xdc:
origDEST_59 := RAX[32:0];
origCOUNT_60 := AND_32(1bv32, (MINUS_32(32bv32, 1bv32)));
RAX := (0bv32 ++ LSHIFT_32((RAX[32:0]), (AND_32(1bv32, (MINUS_32(32bv32, 1bv32))))));
CF := ITE_1(bv2bool(bool2bv(origCOUNT_60 == 0bv32)), CF, RSHIFT_32(origDEST_59, (MINUS_32(32bv32, origCOUNT_60)))[1:0]);
OF := ITE_1(bv2bool(bool2bv(origCOUNT_60 == 0bv32)), OF, ITE_1(bv2bool(bool2bv(origCOUNT_60 == 1bv32)), XOR_1((RAX[32:0][32:31]), CF), unconstrained_13));
SF := ITE_1(bv2bool(bool2bv(origCOUNT_60 == 0bv32)), SF, RAX[32:0][32:31]);
ZF := ITE_1(bv2bool(bool2bv(origCOUNT_60 == 0bv32)), ZF, bool2bv(0bv32 == (RAX[32:0])));
PF := ITE_1(bv2bool(bool2bv(origCOUNT_60 == 0bv32)), PF, NOT_1((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))))), 1bv32)), (XOR_32((RSHIFT_32((XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))), 2bv32)), (XOR_32((RSHIFT_32((RAX[32:0]), 4bv32)), (RAX[32:0]))))))[1:0])));
AF := ITE_1(bv2bool(bool2bv(origCOUNT_60 == 0bv32)), AF, unconstrained_14);
...
procedure dll_func();
  modifies AF,CF,OF,PF,R8,R9,RAX,RCX,RDX,RSP,SF,ZF,mem,origCOUNT_26,origCOUNT_44,origCOUNT_50,origCOUNT_60,origDEST_25,origDEST_43,origDEST_49,origDEST_59,ra_71,t1_31,t1_65,t2_32,t2_66,t_1,t_13,t_17,t_21,t_39,t_5,t_55,t_9;
